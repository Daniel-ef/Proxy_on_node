...
function s_doPlugins(s) {
  ...
  if(s.server=='Day WCMS' && s_URL.indexOf("adobe.com/designcenter")!=-1) {
	  var s_pageNameBase='';
	  var s_URLbase='';
	  if(s_URL.indexOf("/designcenter.html")!=-1) s_URLbase="/designcenter.html";
	  else s_URLbase=window.s_URL.substring(s_URL.indexOf("/designcenter/")+13); // Get designcenter topic
  ...
  else if (s.server=='Day WCMS' && typeof(s_pageName)!=="undefined" && s_pageName.indexOf('ad_') == 0) {
	  ...
	  else if (s_URL.indexOf("/products/creativecloud/")!=-1) {
		  s.channel=s_channel="ad_CreativeCloud";
		  s.prop52=s_prop52=s_prop32+"_CreativeCloud";
		  s.pageName=s_pageName=s.prop52+"_"+s_URL.substring(s_URL.lastIndexOf("/")+1);
		  s_products=s_products.replace(/eVar27=.+/i,"eVar27=");
		  s.products=s_products=s_products+s.pageName;	
  	  }
	  else if (s_URL.indexOf("/education")!=-1 && s_prop11=="Education") {
		  if (s_channel=='ad_') {
			  if (s_URL.indexOf("/education/students")!=-1)  {  
			  	s.channel=s_channel="ad_students";
				if (s_pageName.indexOf("__")!=-1) s.pageName=s_pageName=s_pageName.replace('__','_students_');
			  }
			  else if (s_URL.indexOf("/education/k12")!=-1)  {
				 s.channel=s_channel="ad_k12";
				 if (s_pageName.indexOf("__")!=-1) s.pageName=s_pageName=s_pageName.replace('__','_k12_');  
			  }
			  else if (s_URL.indexOf("/education/higher-ed")!=-1) {
				 s.channel=s_channel="ad_higher-ed";
				 if (s_pageName.indexOf("__")!=-1) s.pageName=s_pageName=s_pageName.replace('__','_higher-ed_');
			  }
			  else {
				 s.channel=s_channel="ad_education";
				 if (s_pageName.indexOf("__")!=-1) s.pageName=s_pageName=s_pageName.replace('__','_education_');
			  }
		  }
	  }
      if (s_pageName.indexOf("_buying-guide_buying-guide.")!=-1 || s_pageName.indexOf("_buying-guideFamily_buying-guide.")!=-1) {
		  var s_splitpageName=s_pageName.split('_'); 			  
		  var s_URLprod=s_URL.substring(s_URL.indexOf("/products/")+10); // Get product from URL
	  ...
	  else if (s_pageName.indexOf("Family")!=-1) { 
		var s_updFamilyFlag=false;
		var s_prodFamily="";
		if (s_URL.indexOf("/products/creativesuite/mastercollection/")!=-1) {
		  s_prodFamily="CSMasterCollection";
		  s_updFamilyFlag=true;
		}
		else if (s_URL.indexOf("/products/creativesuite/designstandard/")!=-1) {
		  s_prodFamily="DesignStandard";
		  s_updFamilyFlag=true;
		}
		else if (s_URL.indexOf("/products/creativesuite/design-web-premium/")!=-1) {
		  s_prodFamily="DesignWebPremium";
		  s_updFamilyFlag=true;
		}
		else if (s_URL.indexOf("/products/creativesuite/production/")!=-1) {	
		  s_prodFamily="ProductionPremium";
		  s_updFamilyFlag=true;
		}
	    else if (s_URL.indexOf("/products/creativesuite/")!=-1) {
		  s_prodFamily="CreativeSuiteFamily";
		  s_updFamilyFlag=true;
	  	}
	  	else if (s_URL.indexOf("/products/photoshopfamily/")!=-1) {
		  s_prodFamily="photoshopFamily";
		  s_updFamilyFlag=true;
	  	}
	  	else if (s_URL.indexOf("/products/acrobat/")!=-1) {
		  s_prodFamily="AcrobatFamily";
		  s_updFamilyFlag=true;
		 }
	  	else if (s_URL.indexOf("/products/elements-family/")!=-1) {
		  s_prodFamily="elements-Family";
		  s_updFamilyFlag=true;
	  	}
		if (s_updFamilyFlag) {
		  s.channel=s_channel="ad_"+s_prodFamily;
		  s.prop52=s_prop52=s_prop32+"_"+s_prodFamily;
		  s.pageName=s_pageName=s.prop52+"_"+s_URL.substring(s_URL.lastIndexOf("/")+1);
		  s_products=s_products.replace(/eVar27=.+/i,"eVar27=");
		  s.products=s_products=s_products+s.pageName;	
		}
...
if (s_URL.indexOf(".com/solutions/digital-marketing.html")!=-1) {	
  s.loadModule("Survey") 
