...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("EBymrdWw9UDzbgYtDXOyfSmiVBA")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
}function e(t,e){var a=i;i=e._mode;var c=n;n=e.block;var l=s;s=e.elem;var u=o;o=e.elemMods;var h=r;r=e.mods;
var d=t(e);return i=a,n=c,s=l,o=u,r=h,d}var i,n,s,o,r,a,c={},l=function(c){function l(t){var e=i;if("attrs"===e)return u(t);
if("price"===e)return"interactive-results"===n?"item"===s?_i(t):$i(t):$i(t);if("date-string"===e)return"z-interactive"===n?"form-date"===s?bi(t):$i(t):$i(t);
if("icon-size"===e)return"z-interactive"===n?"form-checkbox"===s?vi(t):$i(t):$i(t);if("price-format"===e)return"interactive-results"===n?"item"===s?mi(t):$i(t):$i(t);
if("elem"===e)return"dropdown"===n?!(r&&"yes"===r.advanced)==!1?"title-text":$i(t):$i(t);if("format-value"===e){if("value"===s){var e=n;
return"notice"===e?ki(t):"ticker"===e?Mi(t):$i(t)}return $i(t)}if("live"===e){var e=n;return"checkbox"===e?!!s==!1?Ei(t):$i(t):"input"===e?!!s==!1?wi(t):$i(t):$i(t)
}return"auto-content"===e?"auth"===n?xi(t):$i(t):"action"===e?"auth"===n?!!s==!1?Ii(t):$i(t):$i(t):"price-format-cents"===e?"interactive-results"===n?"item"===s?fi(t):$i(t):$i(t):"bem"===e?Si(t):""===e?ui(t):"value"===e?"input"===n?Di(t):$i(t):"default"===e?_e(t):"public-params"===e?"i-global"===n?Oi(t):$i(t):"js"===e?ue(t):"js-params"===e?"b-page"===n?!!s==!1?ji(t):$i(t):$i(t):"mix"===e?ee(t):"env"===e?"i-global"===n?Ai(t):$i(t):"content"===e?j(t):"jsAttr"===e?Ni(t):"tag"===e?C(t):"cls"===e?Li(t):"empty-option"===e?"z-interactive"===n?"form-dropdown"===s?yi(t):$i(t):$i(t):$i(t)
}function u(t){var e=n;if("b-link"===e)return h(t);if("interactive-results"===e)return"image"===s?{style:"background-image:url("+t.ctx.src+")"}:S(t);
if("z-interactive"===e){var e=s;return"send-form"===e?{method:"POST"}:"form"===e?{target:"_blank"}:S(t)
}if("input"===e){var e=s;return"control"===e?m(t):"label"===e?{id:t._labelId,"for":t._inputId,"aria-hidden":!0}:"hint"===e?{id:t._hintId,"for":t._inputId,"aria-hidden":!0}:"clear"===e?{unselectable:"on"}:S(t)
}if("select"===e){var e=s;if("group"===e)return{role:"group","aria-labelledby":t._labelId};if("control"===e){for(var o,a=["id","name","tabindex"],c={};o=a.pop();)t._controlAttrs[o]&&(c[o]=t._controlAttrs[o]);
return"yes"===r.disabled&&(c.disabled="disabled"),c.tabindex=-1,c["aria-hidden"]=!0,t.ctx.controlAttrs||c
}return"item"===e?g(t):S(t)}if("check-button"===e){var e=s;if("control"===e){for(var l,u=t.ctx,d={type:"checkbox"},p=["tabindex","name","value","id"];l=p.pop();)u[l]&&(d[l]=u[l]);
return u.checked&&(d.checked="checked"),u.disabled&&(d.disabled="disabled"),d["aria-labelledby"]=u.labelledby,d
}return"text"===e?{id:t._control.labelledby}:!!s==!1?{"for":t._control.id}:S(t)}if("dropdown"===e)return"hidden-value"===s?!(r&&"yes"===r.advanced)==!1?{type:"hidden",name:t.ctx.name,value:t.ctx.value||""}:S(t):S(t);
if("notice"===e)return"count"===s?!t.ctx.url==!1?{href:t.ctx.url}:w(t):w(t);if("ticker"===e){var e=s;
return"value"===e?{title:t._count}:"count"===e?!t.ctx.url==!1?{href:t.ctx.url}:x(t):x(t)}if("checkbox"===e){var e=s;
if("label"===e){var f=t.ctx.attrs||{};return f["for"]=t._checkboxAttrs.id,f.id=t._labelId,f["aria-hidden"]=!0,f
}if("control"===e){var _=t.ctx.attrs||{};return _.id=t._checkboxAttrs.id,_.type="checkbox",_.autocomplete="off",r.disabled&&(_.disabled="disabled"),"yes"==r.checked&&(_.checked="checked"),_["aria-labelledby"]=t._labelId,_
}return S(t)}if("auth"===e){var e=s;if("social-link"===e)return{role:"button",tabindex:0,title:t.ctx.title,"aria-label":t.ctx.title};
...
if(!!s==!1){var v,y;return{method:"POST",action:t.ctx.url||(v=i,i="action",y=Ii(t),i=v,y),role:"form","aria-label":BEM.I18N("auth","auth")}
}return S(t)}if("image"===e){if(!!s==!1){var k,M=t.ctx,E={src:"//yastatic.net/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",alt:""},C=["alt","width","height"];
for(M.url&&(E.src=M.url);k=C.shift();)M[k]&&(E[k]=M[k]);return E}return S(t)}if("domik"===e)return B(t);
if("slider"===e){var e=s;return"unit"===e?{"aria-hidden":!0}:"title"===e?{id:t._titleId,"aria-hidden":!0}:"mark"===e?{"aria-hidden":!0}:"runner"===e?{hideFocus:"true",id:t.ctx.id,role:"slider","aria-valuenow":t._value,"aria-valuemin":t.ctx.min,"aria-valuemax":t.ctx.max,"aria-disabled":"yes"===(t.ctx.mods||{}).disabled,"aria-labelledby":t.ctx.labelledby,"aria-controls":t.ctx.inputId}:S(t)
}if("suggest2-item"===e){var e=s;return"link"===e?{href:t.ctx.url,target:t.ctx.target}:"bullet"===e?{"aria-hidden":!0}:S(t)
}if("b-icon"===e){if(!!s==!1){var D,P=t.ctx,T={src:"//yastatic.net/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",alt:""},O=["alt","width","height"];
for(P.url&&(T.src=P.url);D=O.shift();)P[D]&&(T[D]=P[D]);return T}return S(t)}return"i-ua"===e?I(t):"button"===e?b(t):S(t)
}function h(t){return!(t.__$anflg40!==!0)==!1?!!s==!1?d(t):p(t):p(t)}function d(t){for(var e,i,n,s=(e=t.__$anflg40,t.__$anflg40=!0,i=h(t),t.__$anflg40=e,i||{}),o=t.ctx,r=o.url,a=o.counter,c=t["i-global"],l=["title","target"],u=/^(https?:)?\/\/([^.?#\/]+\.)*?yandex\.(ru|by|ua|kz|com|com\.tr|net|st)(:\d{1,5})?([#\/?].*)?$/,d=c.isYandexNet&&!c.isPumpkin&&a&&-1===a.indexOf(c.redirPrefix)&&r&&r.match(/^(https?:)?\/\//)&&!r.match(u);n=l.pop();)o[n]&&(s[n]=o[n]);
return a&&(s.onmousedown=a),s.href=d?"//h.yandex.net/?"+encodeURIComponent(r):r,s}function p(t){return!!s==!1?f(t):S(t)
}function f(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,l={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=ui(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(l[c]=r[c]);
return l}function m(t){if(!(t.__$anflg27!==!0)==!1){if(!(r&&"yes"===r.readonly)==!1){var e,i,n=(e=t.__$anflg27,t.__$anflg27=!0,i=m(t),t.__$anflg27=e,i);
...
}function g(t){if(!(t.__$anflg23!==!0)==!1){var e,i,n=(e=t.__$anflg23,t.__$anflg23=!0,i=g(t),t.__$anflg23=e,i||{});
return"yes"===(t.ctx.elemMods||{}).label&&(n.id=t._labelId,n["aria-hidden"]=!0),n}return{id:t.generateId()}
}function b(t){return!t._formSelect==!1?!!s==!1?{role:"listbox",type:"button","aria-haspopup":!0,"aria-expanded":!1}:v(t):v(t)
}function v(t){if(!(t.__$anflg17!==!0)==!1){if(!t.ctx.counter==!1){if(!!s==!1){var e,i;return t.extend((e=t.__$anflg17,t.__$anflg17=!0,i=b(t),t.__$anflg17=e,i),{onmousedown:t.ctx.counter})
}return y(t)}return y(t)}return y(t)}function y(t){if(!(t.__$anflg16!==!0)==!1){if(!t.ctx.url==!1){if(!!s==!1){var e,i,n=t.ctx,o=(e=t.__$anflg16,t.__$anflg16=!0,i=b(t),t.__$anflg16=e,i),a={href:n.url};
return n.target&&(a.target=n.target),r.disabled&&(a["aria-disabled"]=!0),t._.extend(o,a)}return k(t)}return k(t)
}return k(t)}function k(t){return!(t.__$anflg15!==!0)==!1?!!s==!1?!!t.ctx.url==!1?M(t):E(t):E(t):E(t)
}function M(t){for(var e,i,n,s=t.ctx,o=(e=t.__$anflg15,t.__$anflg15=!0,i=b(t),t.__$anflg15=e,i),a={type:s.type||"button"},c=["name","value"];n=c.shift();)s[n]&&(a[n]=s[n]);
return r.disabled&&(a.disabled="disabled"),t._.extend(o,a)}function E(t){if(!!s==!1){var e=t.ctx,i={role:"button"};
return e.tabindex&&(i.tabindex=e.tabindex),i}return S(t)}function w(t){return!!s==!1?{role:"alert","aria-live":"assertive","aria-atomic":!0}:S(t)
}function x(t){return!!s==!1?{role:"alert","aria-live":"assertive","aria-atomic":!0}:S(t)}function B(t){if(!(t.__$anflg9!==!0)==!1){if(!(r&&"popup"===r.type)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg9,t.__$anflg9=!0,i=B(t),t.__$anflg9=e,i||{});
return n.role="dialog",n}return S(t)}return S(t)}return S(t)}function I(t){if(!(t.__$anflg2!==!0)==!1){if(!t._nonce==!1){if(!t["i-global"].nonce==!1){if(!!s==!1){var e,i;
return t.extend((e=t.__$anflg2,t.__$anflg2=!0,i=I(t),t.__$anflg2=e,i),{nonce:t._nonce})}return S(t)}return S(t)
}return S(t)}return S(t)}function S(){return void 0}function C(t){var e=n;if("b-link"===e)return!!s==!1?"a":O(t);
if("input"===e){var e=s;return"calendar"===e?"i":"label"===e||"hint"===e?"label":"clear"===e?"span":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":O(t)
}if("select"===e){var e=s;return"control"===e?"select":"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":O(t)
}if("dropdown"===e)return!(r&&"yes"===r.advanced)==!1?!!s==!1?"span":P(t):P(t);if("z-interactive"===e){var e=s;
return"send-form"===e||"form"===e?"form":"cell"===e||"row"===e||"table"===e?"div":O(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":!!s==!1?"span":O(t)}if("checkbox"===e){var e=s;
return"label"===e?"label":"control"===e?"input":!!s==!1?"span":O(t)}if("popup"===e){var e=s;return"close"===e||"tail"===e?"i":O(t)
}if("frame"===e)return"iframe"===s?"iframe":O(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":T(t):T(t);
if("interactive-results"===e)return"image"===s?"i":O(t);if("auth"===e){var e=s;return"social-link"===e?"a":"social-icon"===e?"i":"retpath"===e?"input":!!s==!1?"form":O(t)
}if("check-button"===e)return"control"===s?"input":!!s==!1?"label":O(t);if("domik"===e){var e=s;return"logo"===e||"roof-body"===e||"roof-border"===e?"i":O(t)
}if("spin"===e)return"label"===s?"span":O(t);if("suggest2-item"===e){var e=s;return"icon"===e?"span":"link"===e?"a":"bullet"===e?"span":"highlight"===e?"b":"fact"===e?"span":"text"===e?t.ctx.tag||"span":!!s==!1?"li":O(t)
}if("image"===e)return!!s==!1?"img":O(t);if("suggest2"===e){var e=s;return"a11y"===e?"span":"items"===e?"ul":O(t)
}if("slider"===e)return!(r&&"interactive"===r["for"])==!1?!~["title-from","title-to"].indexOf(s)==!1?"span":D(t):D(t);
if("b-statcounter"===e)return!!s==!1?"i":O(t);if("b-icon"===e)return!!s==!1?"img":O(t);if("rub"===e)return!!s==!1?"span":O(t);
if("b-autocomplete-item"===e)return!!s==!1?"li":O(t);if("i-ua"===e)return!!s==!1?"script":O(t);if("notice"===e){var e=s;
return"value"===e||"text"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":!!s==!1?"span":O(t)}return O(t)
}function D(t){var e=s;return"unit"===e||"title"===e||"text"===e?"span":"runner"===e?"a":O(t)}function P(t){var e=s;
return"hidden-value"===e?!(r&&"yes"===r.advanced)==!1?"input":O(t):"switcher-text"===e||"text"===e?"span":O(t)
}function T(t){return!!s==!1?"button":O(t)}function O(){return void 0}function j(t){var e=n;if("b-autocomplete-item"===e){if(!(r&&"lingvo"===r.type)==!1){if(!!s==!1){var o=t.ctx.data[1];
return[{tag:"span",elem:"text",content:o.text},{tag:"span",elem:"translation",content:[" — ",o.translation]}]
}return A(t)}return A(t)}if("z-interactive"===e){var e=s;if("form-slider"===e)return z(t);if("form-action"===e)return{block:"button",mix:[{block:"z-interactive",elem:"submit"}],type:"submit",mods:{theme:"action",size:t._size},content:[{elem:"label",content:t.ctx.go_text},{block:"z-interactive",elem:"count",content:t.ctx.found_text}]};
if("form-date"===e)return H(t);if("form-suggest"===e)return V(t);if("form-input"===e){var a=t.ctx.data;
return{block:"input",js:{"default":a["default"]},name:a.id,value:a.selected||a["default"]||"",mods:{size:t._size,filter:t.ctx.filter,"has-default":a["default"]?"yes":"","default-view":!a.selected&&a["default"]?"yes":""},content:[{elem:"label",content:t._.xmlEscape(a.caption)},{elem:"control"}]}
}return"form-checkbox"===e?K(t):"form-dropdown"===e?W(t):"form-table"===e?G(t):te(t)}if("input"===e){var e=s;
return"box"===e?Q(t):"clear"===e?!!t.ctx.content==!1?"":te(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:te(t)
}if("notice"===e){var e=s;if("value"===e){var c,l;return c=i,i="format-value",l=ki(t),i=c,l}return"text"===e?BEM.I18N("notice","notifications"):"count"===e?[{elem:"text"},{elem:"value",count:t.ctx.content}]:!("undefined"!=typeof t.ctx.count)==!1?!!s==!1?{elem:"count",url:t.ctx.url,content:t.ctx.count}:te(t):te(t)
}if("interactive-results"===e){var e=s;return"item"===e?"gallery"===t.ctx.type?F(t):q(t):"ajax-wrap"===e?!(t.ctx.data&&"gallery"===t.ctx.data.template)==!1?R(t):{block:"interactive-results",elem:"main",mods:{type:t.ctx.type},target:t.ctx.target}:q(t)
}if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:te(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:te(t);if("auth"===e){var e=s;
return"register"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=register",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","register")}:X(t):"remember"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=restore",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","remember")}:X(t):"button"===e?!!t.ctx.content==!1?{block:"button",type:"submit",mods:{theme:"action",size:"m"},content:BEM.I18N("auth","logon")}:X(t):"haunter"===e?!!t.ctx.content==!1?{block:"checkbox",mods:{theme:"normal",size:"m"},checkboxAttrs:{id:"auth-haunter",autocomplete:"off",name:"twoweeks",value:"no"},content:{elem:"label",content:BEM.I18N("auth","temporary")}}:X(t):"password"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"passwd",content:[{elem:"hint",content:BEM.I18N("auth","password")},{elem:"control",attrs:{type:"password",maxlength:256,"aria-required":!0}}]}:X(t):"username"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"login",content:[{elem:"hint",content:BEM.I18N("auth","login")},{elem:"control",attrs:{"aria-required":!0}}]}:X(t):X(t)
}if("domik"===e)return!!s==!1?[{elem:"roof",content:[{elem:"roof-border"},{elem:"roof-body"},{elem:"logo"}]},{elem:"content",content:t.ctx.content}]:te(t);
if("popup"===e)return!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:te(t);if("check-button"===e)return!!s==!1?[t._control,{elem:"text",tag:"span",content:t.ctx.content}]:te(t);
if("suggest2-item"===e)return!(r&&"link"===r.interact)==!1?!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:Y(t):Y(t);
if("spin"===e)return $(t);if("rub"===e)return!!s==!1?"Р":te(t);if("slider"===e){var e=s;return"text"===e?t._value:"runner"===e?{elem:"text"}:!!s==!1?[t.ctx.content,{elem:"body",content:{elem:"click"}}]:te(t)
}if("i-ua"===e)return Z(t);if("ticker"===e){var e=s;if("value"===e){var c,l;return c=i,i="format-value",l=Mi(t),i=c,l
}return"text"===e?BEM.I18N("ticker__text","notifications"):"count"===e?[{elem:"text"},{elem:"value",count:t.ctx.content}]:!!s==!1?{elem:"count",url:t.ctx.url,content:t.ctx.count}:te(t)
}return te(t)}function A(e){return!(r&&"foot"===r.type)==!1?!!s==!1?e.ctx.data.slice(1).map(function(t){return this._.isArray(t)?{tag:"span",elem:"foot",content:t[0]}:t
},t(e)):N(e):N(e)}function N(t){return!(r&&"nav"===r.type)==!1?!!s==!1?{elem:"link",tag:"a",attrs:{href:t._url,target:"_blank"},content:[{elem:"link-url",tag:"span",content:t._linkUrlContent},{elem:"link-info",tag:"span",content:t._linkInfoConten}]}:L(t):L(t)
}function L(t){if(!!s==!1){var e=t.ctx.data,i=BEM.blocks["i-common__string"],n=i.escapeHTML(t._.isArray(e)?e[1]:e);
return i.highlight(n,t.ctx.hl)}return te(t)}function $(t){if(!(t.__$anflg34!==!0)==!1){if(!t.ctx.label==!1){if(!!s==!1){var e,i;
return[{elem:"label",content:t.ctx.label},(e=t.__$anflg34,t.__$anflg34=!0,i=$(t),t.__$anflg34=e,i)]}return te(t)
}return te(t)}return te(t)}function F(t){var e,n,s,o,r=t.ctx.itemData,a=t.ctx.index,c=r.meta?r.meta[0]:"";
return[{block:"b-link",url:r.url,target:t.ctx.target,content:{block:"interactive-results",elem:"image",src:r.image,mods:{pos:a}}},{elem:"price",content:(e=i,i="price",n=t._currency,t._currency=t.ctx.currency,s=t.ctx,t.ctx=r,o=_i(t),i=e,t._currency=n,t.ctx=s,o)},{block:"b-link",mix:{block:"interactive-results",elem:"link"},url:r.url,target:t.ctx.target,content:{block:"interactive-results",elem:"title",content:r.title,mods:{pos:a}}},r.description&&{elem:"description",content:r.description},c&&{elem:"meta",content:c}]
}function R(t){for(var e,i=t.ctx.data,n=i.results||[],s=t.ctx.target,o=t.ctx.currency,r=t.ctx.displayCount,a=[],c=0;r>c;c++)e=n[c],a.push({elem:"cell",mods:{first:0===c?"yes":null,last:c===r-1?"yes":null,"main-last":1===c?"yes":"",extra:c>1?"yes":""},content:e&&{block:"interactive-results",elem:"item",type:"gallery",data:i,index:c,itemData:e,currency:o,target:s}});
...
}function q(t){return!!s==!1?U(t):te(t)}function U(t){var e=t.ctx.data,i=t.ctx.i18n;return[{elem:"ajax-wrap",data:e,type:t.ctx.type,target:t.ctx.js.target,currency:t.ctx.js.currency,displayCount:t.ctx.js.displayCount},{elem:"message",elemMods:{type:"error"},content:[{elem:"message-title",content:i.errorTitle},{elem:"message-description",content:i.errorDescription},{block:"b-link",mix:{block:"interactive-results",elem:"submit"},target:t.ctx.js.target,content:t.ctx.host.name,url:t.ctx.host.url}]},{elem:"message",elemMods:{type:"not-found"},content:{elem:"message-title",content:i.notFound}},{elem:"fade",content:{block:"spin",mods:{theme:"gray-32",progress:"yes"===(t.ctx.mods||{}).empty?"yes":""},js:!0}}]
}function z(t){var e=t.ctx.data,i=e.selected,n=i.from||i["default-from"],s=i.to||i["default-to"],o=t.ctx.isSliderDegradation,r="",a="",c=t.ctx.size;
if(o!==!0&&(r={size:c,block:"slider",mix:[{block:"z-interactive",elem:"slider"}],mods:{type:"range",theme:"normal",interactive:"no",size:"s",orientation:"horiz",input:"hidden","for":"interactive"},js:{min:e.min,max:e.max,scale:[{value:e.min,step:e.step},{value:e.max}]},content:[{elem:"title",content:[e.caption+" ",e["from-caption"]+" ",{elem:"title-from",content:n}," "+e["to-caption"]+" ",{elem:"title-to",content:s}," "+e.unit]},{elem:"info",elemMods:{preset:"inline"},content:[{block:"input",mods:{size:"s"},value:n,content:{elem:"control",attrs:{name:e.id}}},{block:"input",mods:{size:"s"},value:s,content:{elem:"control",attrs:{name:e.id}}}]}]}),o!==!1){var l=e.unit?", "+e.unit:"",n=e["from-caption"]?(l?" ":", ")+e["from-caption"]:"",s=e["to-caption"]?(l?" ":", ")+e["to-caption"]:"",u=e.caption+n+l,h=e.caption+s+l,d={id:e.id,selected:e.selected&&e.selected.from,"default":e.selected&&e.selected["default-from"],caption:u},p={id:e.id,selected:e.selected&&e.selected.to,"default":e.selected&&e.selected["default-to"],caption:h};
a=[{elem:"form-input",mods:{first:"yes"},size:3,filter:"digit",data:d},{elem:"form-input",mods:{last:"yes"},size:3,filter:"digit",data:p}]
}return[r,a]}function H(t){var e,n,s,o,r,a,c,l,u=t.ctx.data;return isNaN(parseInt(u.min,10))||(e=i,i="date-string",n=t._offset,t._offset=parseInt(u.min,10),s=bi(t),i=e,t._offset=n,c=s),isNaN(parseInt(u.max,10))||(o=i,i="date-string",r=t._offset,t._offset=parseInt(u.max,10),a=bi(t),i=o,t._offset=r,l=a),{block:"input",js:{earlierLimit:c,laterLimit:l,months:t.ctx.i18n.months,weekDays:t.ctx.i18n.weekdays,popupMix:{block:"input",elem:"calendar-popup",elemMods:{type:"interactive"}},"default":u["default"]},name:u.id,value:u.selected||u["default"]||"",mods:{size:t._size,"has-calendar":"yes","has-default":u["default"]?"yes":"","default-view":!u.selected&&u["default"]?"yes":""},content:[{elem:"label",content:t._.xmlEscape(u.caption)},{elem:"control",content:{elem:"calendar"}}]}
}function V(t){var e=t.ctx.data,i=e["default"]&&e["default"].key,n=e.selected&&e.selected.key;return{block:"input",name:e.id,value:n&&e.selected.caption||i&&e["default"].caption||"",attrs:{"data-key":n&&e.selected.key||i&&e["default"].key,"data-val":n&&e.selected.caption||i&&e["default"].caption},mods:{size:t._size,"nosplit-words":"yes","noprevent-tab":"yes","default-view":!n&&i?"yes":"","z-interactive":"yes"},js:{"default":e["default"],i18n:{empty:t.ctx.i18n.empty_item_text},showOverChars:1},content:[{elem:"label",content:t._.xmlEscape(e.caption)},{elem:"control"}]}
}function K(t){var e,n,s=t.ctx.data,o=(e=i,i="icon-size",n=vi(t),i=e,n),r={};return r[o]="check",{block:"check-button",js:{val:s.checked},mods:{size:t._size,checked:s.selected?"yes":"","z-interactive":"yes","z-interactive-exp":t._exp?"yes":""},name:s.id,value:s.checked,content:[{block:"b-icon",mix:[{block:"check-button",elem:"icon",mods:r}],alt:"Metro"},t._.xmlEscape(s.caption)]}
}function W(e){var n,s,o,r=e.ctx.data,a=t(e),c=r["default"]&&r["default"].key,l=r.selected&&r.selected.key;
return{block:"select",name:r.id,mods:{size:e._size,theme:"normal","z-interactive":"yes","z-interactive-exp":e._exp?"yes":""},js:{popupMods:{"z-interactive":"yes","z-interactive-exp":e._exp?"yes":""},popupParams:{directions:["bottom-left","bottom-right"]}},content:[{tag:"span",elem:"caption",content:e._.xmlEscape(r.caption)},{block:"button",mods:{size:e._size},content:l&&e._.xmlEscape(r.selected.caption)||c&&e._.xmlEscape(r["default"].caption)||""},{elem:"control",content:[(n=i,i="empty-option",s=e._label,e._label=e._.xmlEscape(r.caption),o=yi(e),i=n,e._label=s,o)].concat(r.values.map(function(t){return{elem:"option",attrs:l&&r.selected.key==t.key||!l&&c&&r["default"].key==t.key?{value:t.key,selected:"selected"}:{value:t.key},content:a._.xmlEscape(t.caption)}
}))}]}}function G(t){var e=t.ctx,i=t.ctx.i18n,n=t.ctx.data||{},s=n.filters||[],o=(t.ctx.baseline3,0),r=5,a=function(t,e){if(o===r)return void 0;
...
},l=[],u=function(t){for(var s=0;s<t.length;s++){var o=t[s],r=o.view&&o.view["expected-width-in-chars"],a="drop-down"==o.type||"geo"==o.type;
if(a&&o.values&&o.values.length>0)o["default"]=o["default-selected"],l.push({elem:"form-dropdown",chars:r,data:o});
...
o.values&&o.values.length>0?(c.values=h.values=o.values,l.push([{elem:"form-dropdown",chars:r,data:c},{elem:"form-dropdown",chars:r,data:h}])):o.suggest&&(c.site_id=h.site_id=n["site-id"],l.push([{elem:"form-suggest",chars:r,data:c,i18n:i},{elem:"form-suggest",chars:r,data:h,i18n:i}]))
}else if("checkbox"==o.type)l.push({elem:"form-checkbox",chars:r,data:o});else if("date"==o.type)l.push({elem:"form-date",chars:r,data:o,i18n:i});
...
l.push([{elem:"form-date",chars:Math.ceil(r/2),data:c,i18n:i},{elem:"form-date",chars:Math.floor(r/2),data:h,i18n:i}])
}else"range"==o.type?l.push({elem:"form-slider",mods:{degradable:e.isSliderDegradation?"yes":""},isSliderDegradation:e.isSliderDegradation,size:6,data:o}):"textbox"==o.type&&l.push({elem:"form-input",chars:r,data:o});
o["sub-filters"]&&o["sub-filters"].length>0&&u(o["sub-filters"])}},h=[];u(s);for(var d=0,p=l.length;p>d;d++){var f=l[d];
...
})}}function Q(t){if(!(t.__$anflg26!==!0)==!1){if(!(r&&"yes"===r["has-calendar"])==!1){var e,i;return[(e=t.__$anflg26,t.__$anflg26=!0,i=Q(t),t.__$anflg26=e,i),{elem:"calendar"}]
}return te(t)}return te(t)}function X(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=xi(t),i=e,n),{elem:"retpath"}]
}return te(t)}function Y(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):te(e)}function Z(t){if(!(t.__$anflg3!==!0)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg3,t.__$anflg3=!0,i=Z(t),t.__$anflg3=e,i);
...
}return J(t)}return J(t)}function J(t){return!!s==!1?[";(function(d,e,c,r){","e=d.documentElement;",'c="className";','r="replace";','e[c]=e[c][r]("i-ua_js_no","i-ua_js_yes");','if(d.compatMode!="CSS1Compat")','e[c]=e[c][r]("i-ua_css_standart","i-ua_css_quirks")',"})(document);"].join(""):te(t)
}function te(t){return t.ctx.content}function ee(t){var e=n;if("b-autocomplete-item"===e)return!(r&&"foot"===r.type)==!1?!!s==!1?[{mods:{enterable:"no"}}]:ie(t):ie(t);
if("input"===e)return!t._inSlider==!1?!!s==!1?[{block:"slider",elem:"input"}]:ae(t):ae(t);if("image"===e)return!(r&&"yes"===r.placeholder)==!1?!!s==!1?[{block:"content-placeholder"}]:le(t):le(t);
if("select"===e){if("group"===s){var i=t.isFirst()?t.isLast()?"both":"first":t.isLast()?"last":"middle";
return{mods:{position:i}}}return le(t)}if("slider"===e)return"body"===s?ne(t):le(t);if("notice"===e){var e=s;
return"text"===e?[{block:"a11y-hidden"}]:"count"===e?!!t.ctx.url==!1?[{elem:"plain"}]:le(t):le(t)}if("ticker"===e){var e=s;
return"text"===e?[{block:"a11y-hidden"}]:"count"===e?!!t.ctx.url==!1?[{elem:"plain"}]:ce(t):ce(t)}return"dropdown"===e?!!s==!1?[{mods:{action:"closed"}}]:le(t):"suggest2-item"===e?"text"===s?!(r&&"link"===r.interact)==!1?!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:le(t):le(t):le(t):"suggest2"===e?!!s==!1?[{block:"suggest2-detect",js:!0}]:le(t):"button"===e?!t._formSelect==!1?!!s==!1?[{block:t._formSelect.block,elem:"button"}]:le(t):le(t):le(t)
}function ie(t){return!!s==!1?[{mods:{pers:t.ctx.pers?"yes":""}}]:le(t)}function ne(t){return!(t.__$anflg38!==!0)==!1?!r.type==!1?!!t.ctx._wType==!1?se(t):oe(t):oe(t):oe(t)
}function se(t){var e,i,n,s,o,a=(e=t.__$anflg38,t.__$anflg38=!0,n=t.ctx,s=n._wType,n._wType=!0,o=ne(t),n._wType=s,i=o,t.__$anflg38=e,i||[]);
return a.push({elemMods:{type:r.type}}),a}function oe(t){return!(t.__$anflg37!==!0)==!1?!r.orientation==!1?!!t.ctx._wOrigin==!1?re(t):le(t):le(t):le(t)
}function re(t){var e,i,n,s,o,a=(e=t.__$anflg37,t.__$anflg37=!0,n=t.ctx,s=n._wOrigin,n._wOrigin=!0,o=ne(t),n._wOrigin=s,i=o,t.__$anflg37=e,i||[]);
return a.push({elemMods:{origin:"vert"===r.orientation?"y":"x"}}),a}function ae(t){return"ahead"===s?[{block:"input",elem:"input"}]:le(t)
}function ce(t){return!!t._count==!1?!!s==!1?[{mods:{state:"empty"}}]:le(t):le(t)}function le(){return void 0
}function ue(t){var e=n;if("b-autocomplete-item"===e)return!(r&&"nav"===r.type)==!1?!!s==!1?{val:t._url}:he(t):he(t);
if("input"===e)return de(t);if("select"===e)return!!s==!1?!0:me(t);if("notice"===e)return!!s==!1?!0:!("undefined"!=typeof t.ctx.count)==!1?!!s==!1?{count:t.ctx.count}:me(t):me(t);
if("ticker"===e)return!!s==!1?{count:t._count,maxCount:t._maxCount}:me(t);if("z-interactive"===e)return"form-table"===s?{size:t.ctx.size,i18n:t.ctx.i18n,limit:t.ctx.limit,backend:t.ctx.backend,baseline3:t.ctx.baseline3}:me(t);
if("button"===e||"dropdown"===e||"auth"===e)return!!s==!1?!0:me(t);if("domik"===e)return!(r&&"hidden"===r.type)==!1?!!s==!1?!1:me(t):me(t);
if("suggest2-item"===e||"check-button"===e||"suggest2"===e)return!!s==!1?!0:me(t);if("checkbox"===e){if(!!s==!1){var o,a,c=t.ctx.js,l=Object(c).hasOwnProperty("live")?c.live:(o=i,i="live",a=Ei(t),i=o,a);
return{live:l}}return me(t)}return me(t)}function he(t){return!!s==!1?!0:!t.ctx.search_cgi==!1?!t._.isArray(t.ctx.search_cgi)==!1?{cgi:t.ctx.search_cgi}:me(t):me(t)
}function de(t){if(!(t.__$anflg28!==!0)==!1){if(!(r&&"ahead"===r.tap)==!1){if(!!s==!1){var e,i;return t.extend((e=t.__$anflg28,t.__$anflg28=!0,i=de(t),t.__$anflg28=e,i),{live:!1})
}return pe(t)}return pe(t)}return pe(t)}function pe(t){return!!s==!1?fe(t):me(t)}function fe(t){var e,n,s=(e=i,i="live",n=wi(t),i=e,n),o=t.ctx.js;
...
}function me(){return void 0}function _e(t){var e=n;if("b-autocomplete-item"===e)return ge(t);if("z-interactive"===e)return"form-table"===s?Se(t):$i(t);
if("select"===e)return Ce(t);if("button"===e)return Oe(t);if("ticker"===e)return Ne(t);if("interactive-results"===e)return Be(t);
if("input"===e)return Re(t);if("popup"===e)return Ve(t);if("dropdown"===e)return"popup"===s?!(t.__$anflg13!==!0)==!1?Ge(t):$i(t):$i(t);
if("auth"===e)return Qe(t);if("domik"===e)return Je(t);if("check-button"===e)return we(t);if("suggest2-item"===e){var e=s;
return"icon"===e?ii(t):"fact"===e?oi(t):$i(t)}return"spin"===e?!(t.__$anflg33!==!0)==!1?!!s==!1?Ee(t):$i(t):$i(t):"i-bem"===e?"i18n"===s?ri(t):$i(t):"image"===e?!(t.__$anflg35!==!0)==!1?!t.ctx==!1?!(t.ctx.text||t.ctx.mods&&"cover"===t.ctx.mods.type)==!1?!!t.ctx.wrapped==!1?Me(t):$i(t):$i(t):$i(t):$i(t):"i-global"===e?ai(t):"slider"===e?ve(t):"i-ua"===e?li(t):"checkbox"===e?$e(t):$i(t)
}function ge(t){return!(t.__$anflg39!==!0)==!1?!(r&&"nav"===r.type)==!1?!!s==!1?be(t):$i(t):$i(t):$i(t)
}function be(t){var e,i,n,s,o,r,a=t.ctx.data,c=a[4],l=(c.match(/^\w[\w-]*:\/\//g)?"":"http://")+c,u=BEM.blocks["i-common__string"].escapeHTML(a[3]),h="&nbsp;&mdash;&nbsp;"+BEM.blocks["i-common__string"].highlight(a[2],t.ctx.hl);
return e=t.__$anflg39,t.__$anflg39=!0,n=t._linkUrlContent,t._linkUrlContent=u,s=t._linkInfoConten,t._linkInfoConten=h,o=t._url,t._url=l,r=ge(t),t._linkUrlContent=n,t._linkInfoConten=s,t._url=o,i=r,t.__$anflg39=e,i
}function ve(t){return"runner"===s?ye(t):ke(t)}function ye(t){if(!!t._done==!1){var e,i,n;return e=t._value,t._value=t.ctx.value,i=t._done,t._done=!0,n=ye(t),t._value=e,t._done=i,n
}return ke(t)}function ke(t){if(!(t.__$anflg36!==!0)==!1){if(!!s==!1){var e=t.generateId(),i=t.__$anflg36;
t.__$anflg36=!0;var n=t._inSlider;t._inSlider=!0;var o=t._titleId;return t._titleId="title"+e,ve(t),t._inSlider=n,t._titleId=o,t.__$anflg36=i,void 0
}return $i(t)}return $i(t)}function Me(t){var e,n,s,o,r,a=t.ctx.text;return t.ctx.wrapped=!0,e=t.__$anflg35,t.__$anflg35=!0,s=t.ctx,t.ctx={block:"image",elem:"wrapper",elemMods:{type:a?"text":"cover"},attrs:!a&&{style:"width:"+t.ctx.width+"px; height:"+t.ctx.height+"px;"},content:[t.ctx,a&&{elem:"text",content:a}]},o=i,i="",r=ui(t),t.ctx=s,i=o,n=r,t.__$anflg35=e,n
}function Ee(t){var e,n,s,o,r,a=t.ctx.mods||{};return a.theme||(a.theme="gray-32"),t.ctx.mods=a,t.ctx.content={block:"image",mix:[{block:"spin",elem:"icon"}]},e=t.__$anflg33,t.__$anflg33=!0,s=t.ctx,t.ctx=t.ctx,o=i,i="",r=ui(t),t.ctx=s,i=o,n=r,t.__$anflg33=e,n
}function we(t){return!(t.__$anflg32!==!0)==!1?!!s==!1?xe(t):$i(t):$i(t)}function xe(t){var e=t.ctx,i=(e.controlAttrs||{}).id||t.generateId(),n=e.mods||{};
n.theme=n.theme||"normal";var s=t.__$anflg32;t.__$anflg32=!0;var o=t._control;t._control={elem:"control",attrs:e.controlAttrs,id:i,labelledby:"text"+i,name:e.name,tabindex:e.tabindex,checked:r.checked,disabled:r.disabled,value:e.value||e.content};
var a=e.mods;e.mods=n,we(t),t._control=o,e.mods=a,t.__$anflg32=s}function Be(t){if(!(t.__$anflg31!==!0)==!1){if(!(t.ctx.data&&t.ctx.data.results_count<=0)==!1){if(!!s==!1){var e=t.__$anflg31;
t.__$anflg31=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{message:"not-found"}),Be(t),i.mods=n,t.__$anflg31=e,void 0
}return Ie(t)}return Ie(t)}return Ie(t)}function Ie(t){if(!(t.__$anflg30!==!0)==!1){if(!!t.ctx.data==!1){if(!!s==!1){var e=t.__$anflg30;
t.__$anflg30=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{empty:"yes"}),Be(t),i.mods=n,t.__$anflg30=e,void 0
}return $i(t)}return $i(t)}return $i(t)}function Se(t){if(!(t.__$anflg29!==!0)==!1){var e=t.__$anflg29;
t.__$anflg29=!0;var i=t._exp;t._exp=t.ctx.exp;var n=t._size;return t._size=t.ctx.size,Se(t),t._exp=i,t._size=n,t.__$anflg29=e,void 0
}return $i(t)}function Ce(t){return"group"===s?De(t):Pe(t)}function De(t){if(!(t.__$anflg25!==!0)==!1){var e=t.__$anflg25;
t.__$anflg25=!0;var i=t._labelId;return t._labelId=t.generateId(),De(t),t._labelId=i,t.__$anflg25=e,void 0
}return Pe(t)}function Pe(t){return!(t.__$anflg22!==!0)==!1?!!s==!1?Te(t):$i(t):$i(t)}function Te(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg22;
t.__$anflg22=!0;var o=t._controlAttrs;t._controlAttrs={id:i,name:e.name||i,tabindex:e.tabindex};var a=t._formSelect;
t._formSelect={block:n,mods:r,tabindex:e.tabindex},Ce(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg22=s
}function Oe(t){return!(t.__$anflg24!==!0)==!1?!t._formSelect==!1?!!s==!1?je(t):Ae(t):Ae(t):Ae(t)}function je(t){var e=t.ctx,i=t._formSelect.mods,n=t._formSelect.tabindex,s=e.mods||{};
s.arrow="down",i.theme&&(s.theme=i.theme),i.size&&(s.size=i.size),"yes"===i.disabled&&(s.disabled="yes"),e.mods=s,n&&(e.tabindex=n);
var o=t.__$anflg24;t.__$anflg24=!0;var r=t.ctx,a=r._theme;r._theme=!0,Oe(t),r._theme=a,t.__$anflg24=o
}function Ae(t){if(!(t.__$anflg14!==!0)==!1){if(!!s==!1){var e=t.ctx.mods||{};e.theme=e.theme||"normal";
var i=t.__$anflg14;t.__$anflg14=!0;var n=t.ctx,o=n.mods;return n.mods=e,Oe(t),n.mods=o,t.__$anflg14=i,void 0
}return $i(t)}return $i(t)}function Ne(t){return!(t.__$anflg21!==!0)==!1?!!s==!1?Le(t):$i(t):$i(t)}function Le(t){var e=t.__$anflg21;
t.__$anflg21=!0;var i=t._count;t._count=t.ctx.count||0;var n=t._maxCount;t._maxCount=t.ctx.maxCount||99;
var s=t._url;t._url=t.ctx.url,Ne(t),t._count=i,t._maxCount=n,t._url=s,t.__$anflg21=e}function $e(t){return!(t.__$anflg20!==!0)==!1?!!s==!1?Fe(t):$i(t):$i(t)
}function Fe(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg20;t.__$anflg20=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=e.mods;e.mods=s,$e(t),t._checkboxAttrs=r,t._labelId=a,e.mods=c,t.__$anflg20=o
}function Re(t){var e=s;return"hint"===e?!(t.__$anflg19!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?qe(t):ze(t):ze(t):ze(t):"control"===e?!(t.__$anflg5!==!0)==!1?!!r.clear==!1?Ue(t):ze(t):ze(t):ze(t)
}function qe(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg19,t.__$anflg19=!0,s=t.ctx,t.ctx=a,o=i,i="",r=ui(t),t.ctx=s,i=o,n=r,t.__$anflg19=e,n
}function Ue(t){var e=t.__$anflg5;t.__$anflg5=!0;var n=t.ctx;t.ctx={elem:"box",tag:"span",content:[t.ctx,{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]};
var s=i;i="",ui(t),t.ctx=n,i=s,t.__$anflg5=e}function ze(t){return!(t.__$anflg4!==!0)==!1?!!s==!1?He(t):$i(t):$i(t)
}function He(t){var e,n,s,o=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Di(t),i=e,t.ctx=n,s),a=t.ctx.id||t.generateId(),c=t.ctx.mods||{},l=t.ctx.js||{};
c.theme=c.theme||"normal";var u=t.__$anflg4;t.__$anflg4=!0;var h=t._inputId;t._inputId=a;var d=t._labelId;
...
t._live=l.live||!1;var v=t.ctx,y=v.mods;v.mods=c,Re(t),t._inputId=h,t._labelId=d,t._hintId=p,t._name=f,t._value=m,t._inputLink=_,t._disabled=g,t._live=b,v.mods=y,t.__$anflg4=u
}function Ve(t){if(!(t.__$anflg18!==!0)==!1){if(!(r&&"yes"===r["has-close"])==!1){if(!!s==!1){t.ctx.content.push({elem:"close"});
var e=t.__$anflg18;return t.__$anflg18=!0,Ve(t),t.__$anflg18=e,void 0}return Ke(t)}return Ke(t)}return Ke(t)
}function Ke(t){return!!t._popupDefaults==!1?!!s==!1?We(t):$i(t):$i(t)}function We(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
i.style=(i.style||"")+";z-index:"+e.zIndex+";"}var n=t._popupDefaults;t._popupDefaults=!0,Ve(t),t._popupDefaults=n
}function Ge(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));var s=t.__$anflg13;
t.__$anflg13=!0;var o=t.ctx;t.ctx={block:"popup",mix:n,mods:e.mods,attrs:e.attrs,js:e.js,content:[{elem:"tail"},{elem:"content",content:e.content}]};
var r=i;i="",ui(t),t.ctx=o,i=r,t.__$anflg13=s}function Qe(t){return"retpath"===s?Xe(t):Ye(t)}function Xe(t){if(!(t.__$anflg12!==!0)==!1){var e=t.__$anflg12;
t.__$anflg12=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,Xe(t),t._retpath=i,t.__$anflg12=e,void 0
}return Ye(t)}function Ye(t){return!(t.__$anflg11!==!0)==!1?!!s==!1?Ze(t):$i(t):$i(t)}function Ze(t){var e,i,n,s;
...
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",Qe(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg11=o
}function Je(t){return!(t.__$anflg10!==!0)==!1?!(r&&"hidden"===r.type)==!1?!!s==!1?ti(t):ei(t):ei(t):ei(t)
}function ti(t){var e,n,s,o,r;return e=t.__$anflg10,t.__$anflg10=!0,s=t.ctx,t.ctx={block:"auth",mix:[{block:"domik",mods:{type:"hidden"}}],js:!1,attrs:{style:"display:none"},content:[{tag:"input",attrs:{name:"login"}},{tag:"input",attrs:{name:"passwd",type:"password"}}]},o=i,i="",r=ui(t),t.ctx=s,i=o,n=r,t.__$anflg10=e,n
}function ei(t){if(!!s==!1){if(!!(t.ctx.mods||{}).logo==!1){var e,i;BEM.blocks?(i=BEM.blocks["i-global"],e=i.param("lang")):(i=t["i-global"],e=i.lang);
var n=t.ctx,o=n.mods;return n.mods=t.extend(t.ctx.mods||{},{logo:~["en","tr"].indexOf(e)?"en":"ru"}),Je(t),n.mods=o,void 0
}return $i(t)}return $i(t)}function ii(t){if(!(t.__$anflg8!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg8;
t.__$anflg8=!0;var i=o,n=i.weather;return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),ii(t),i.weather=n,t.__$anflg8=e,void 0
}return ni(t)}return ni(t)}function ni(t){return!(t.__$anflg7!==!0)==!1?si(t):$i(t)}function si(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'")'}));
var i=t.__$anflg7;t.__$anflg7=!0,ii(t),t.__$anflg7=i}function oi(t){if(!(t.__$anflg6!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color});
var e=t.__$anflg6;return t.__$anflg6=!0,oi(t),t.__$anflg6=e,void 0}return $i(t)}return $i(t)}function ri(t){var e,n,s,o;
if(!t.ctx)return"";var r=t.ctx,a=r.keyset,c=r.key,l=r.params||{};if(!a&&!c)return"";if(r.content){var u;
l.content=(u=[],e=t._buf,t._buf=u,n=i,i="",s=t.ctx,t.ctx=r.content,o=ui(t),t._buf=e,i=n,t.ctx=s,u.join(""))
}t._buf.push(BEM.I18N(a,c,l))}function ai(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?ci(t):$i(t)
}function ci(t){var e,i,n,s=t.ctx.params||{},o=t["i-global"],r=s.tld&&s.tld!==o.tld;r&&(e=s.tld,i="tr"===e?"yandex.com.tr":"yandex."+e,n=-1!=["ua","by","kz"].indexOf(e)?"yandex.ru":i,o["content-region"]=e,o["click-host"]="//clck."+n,o["passport-host"]="https://passport."+n,o["pass-host"]="https://pass."+i,o["social-host"]="https://social."+i,o["export-host"]="https://export."+i);
for(var a in s)o[a]=s[a]}function li(t){if(!(t.__$anflg1!==!0)==!1){if(!t["i-global"].nonce==!1){if(!!t._nonce==!1){if(!!s==!1){var e=t.__$anflg1;
t.__$anflg1=!0;var i=t._nonce;return t._nonce=t["i-global"].nonce,li(t),t._nonce=i,t.__$anflg1=e,void 0
}return $i(t)}return $i(t)}return $i(t)}return $i(t)}function ui(t){return!t._==!1?!!t._.cleverSubstring==!1?(t._.cleverSubstring=function(t,e,i){return t.length>e+i?t.substring(0,e-1)+"…":t
},Gi(t),void 0):hi(t):hi(t)}function hi(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,Gi(t),void 0):di(t):di(t):di(t)
}function di(t){return!!t["i-global"]==!1?pi(t):$i(t)}function pi(t){for(var e,o,r,a,c,l,u,h,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];h=p.shift();)d[h]=(e=i,i="default",o=n,n="i-global",r=s,s=h,a=ai(t),i=e,n=o,s=r,a);
t["i-global"]=t._.extend(d,(c=i,i="env",l=n,n="i-global",u=Ai(t),i=c,n=l,u)),Gi(t)}function fi(t){if(0===t._value)return"";
var e=t._value<10?"0"+t._value:t._value,i="tr"===BEM.I18N.lang()?{elem:"price-cents",content:e}:e;return[",",i]
}function mi(t){var e="tr"===BEM.I18N.lang()?".":"&thinsp;";return t._value.replace(/(\d)(?=(?:\d\d\d)+$)/g,"$1"+e)
}function _i(t){return!t.ctx.price_currency==!1?gi(t):""}function gi(t){var e,n,s,o,r,a,c,l=(t.ctx.price_currency||"").toUpperCase();
return[(e=i,i="price-format",n=t._value,t._value=t.ctx.price,s=mi(t),i=e,t._value=n,s),(o=i,i="price-format-cents",r=t._value,t._value=parseInt(t.ctx.price_cents,10),a=t._currency,t._currency=t.ctx.price_currency,c=fi(t),i=o,t._value=r,t._currency=a,c),"&nbsp;"+(t._currency[l]||l)]
}function bi(t){var e=new Date;e.setDate(e.getDate()+(t._offset||0));var i=e.getMonth()+1,n=e.getDate();
return e.getFullYear()+"-"+(10>i?"0"+i:i)+"-"+(10>n?"0"+n:n)}function vi(){return 24}function yi(){return{block:"select",elem:"option",attrs:{value:""},content:"&mdash;"}
}function ki(t){var e,i,n=t.ctx;return e=parseInt(n.count,10),i=n.maxCount?n.maxCount:99,e>i?i+"+":e}function Mi(t){return t._count>t._maxCount?t._maxCount+"+":t._count
}function Ei(){return!1}function wi(){return!1}function xi(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Bi(t):Bi(t)
}function Bi(t){return!!s==!1?[]:$i(t)}function Ii(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
}function Si(t){var e=n;return"suggest2-item"===e?"highlight"===s?!1:Ci(t):"i-ua"===e?!!s==!1?!1:Ci(t):Ci(t)
}function Ci(){return void 0}function Di(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:Pi(t):Pi(t)}function Pi(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;
t._buf=e;var o=i;return i="",ui(t),t._buf=n,i=o,e.join("")}return Ti(t)}return Ti(t)}function Ti(t){return!!s==!1?"":$i(t)
}function Oi(t){var e=s;return"nonce"===e||"isPageLoadCounter"===e||"isCounterHeights"===e||"serpRequestExtraParams"===e||"isGameEnabled"===e||"lr"===e||"ajaxUrl"===e||"framebuster"===e||"shownResult"===e||"pg"===e||"isCounterSerpview"===e||"nahodki"===e||"cache"===e||"tld"===e||"pref-ajax"===e||"reqid"===e||"maxAjaxUrlLength"===e||"query"===e||"pid"===e?!0:!s==!1?{id:1,lang:1,tld:1,"content-region":1,"user-region":1,login:1,displayName:1,index:1,yandexuid:1,"passport-host":1,"pass-host":1,"passport-msg":1,"static-host":1,"lego-static-host":1,"social-host":1,clck:1,"click-host":1,"export-host":1,"i-host":1,"social-retpath":1,"lego-path":1,sid:1,retpath:1,uid:1}[s]||!1:$i(t)
}function ji(t){var e,o,r,a,c,l=t["i-global"],u={},h={block:"i-global",js:u};for(c in l)l.hasOwnProperty(c)&&(e=i,i="public-params",o=n,n="i-global",r=s,s=c,a=Oi(t),i=e,n=o,s=r,a)&&(u[c]=l[c]);
return h}function Ai(t){return!!s==!1?{}:$i(t)}function Ni(){return void 0}function Li(){return void 0
}function $i(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Fi(t):Ri(t):Ri(t):Ri(t)}function Fi(i){function n(){if("no-follow"===this.ctx.link)return void 0;
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(Gi,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function Ri(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?qi(t):Ui(t):Ui(t):Ui(t)
}function qi(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
r=c.log.map(function(t){return{key:t[0],value:i(this,t[0],t[1])}},t(e)).reverse();var u=e.ctx,h=u.cache;
u.cache=null;var d=e._cacheLog;e._cacheLog=null;var p=e.ctx,f=p.link;p.link=c.link,l(e),u.cache=h,e._cacheLog=d,p.link=f,r.forEach(function(t){i(this,t.key,t.value)
},t(e))}else e._buf.push(n.log[o]);return e._links=s,n.res}var m,_=[],g=e.ctx,b=g.cache;g.cache=null;
var v=e._cachePos;e._cachePos=e._buf.length;var y=e._cacheLog;e._cacheLog=_;var k=e._localLog;e._localLog=[],m=l(e);
...
}function Ui(t){var e=i;if("default"===e)return zi(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?Hi(t):Vi(t)
}return Ki(t)}function zi(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,l,h,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,I,S,D,P,T=t.BEM,O=t.ctx,A=t._buf;
if(c=i,i="tag",v=C(t),i=c,P=v,"undefined"!=typeof P||(P=O.tag),"undefined"!=typeof P||(P="div"),P){var N,L;
n&&O.js!==!1&&(l=i,i="js",h=ue(t),i=l,L=h,L=L?t._.extend(O.js,L===!0?{}:L):O.js===!0?{}:O.js,L&&((N={})[T.INTERNAL.buildClass(n,O.elem)]=L)),A.push("<",P);
var $=(d=i,i="bem",p=Si(t),i=d,p);"undefined"!=typeof $||($="undefined"!=typeof O.bem?O.bem:O.block||O.elem);
var F=(f=i,i="cls",m=Li(t),i=f,m);F||(F=O.cls);var R=O.block&&N&&!O.elem;if($||F){if(A.push(' class="'),$){T.INTERNAL.buildClasses(n,O.elem,O.elemMods||O.mods,A);
var q=(_=i,i="mix",g=ee(t),i=_,g);if(O.mix&&(q=q?[].concat(q,O.mix):O.mix),q){var U={};U[e(n,s)]=!0,t._.isArray(q)||(q=[q]);
for(var z=0;z<q.length;z++){var H=q[z];if(H){var V=H.block||H.elem,K=H.block||H._block||n,W=H.elem||H._elem||s,G=H.mods||r,Q=H.elemMods||{};
if(V&&A.push(" "),T.INTERNAL[V?"buildClasses":"buildModsClasses"](K,H.elem||H._elem||(H.block?void 0:s),H.elemMods||H.mods,A),H.js&&((N||(N={}))[T.INTERNAL.buildClass(K,H.elem)]=H.js===!0?{}:H.js,R||(R=K&&!H.elem)),V&&!U[e(K,W)]){U[e(K,W)]=!0;
var X=(b=n,n=K,a=s,s=W,y=r,r=G,k=o,o=Q,M=i,i="mix",E=ee(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&U[e(Z.block,Z.elem)]||(Z._block=K,Z._elem=W,q.splice(z+1,0,Z))}}}}}}F&&A.push($?" ":"",F),R&&A.push(" i-bem"),A.push('"')
}if(N){var J=(w=i,i="jsAttr",x=Ni(t),i=w,x);A.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(N)),'"')
}var te=(B=i,i="attrs",I=u(t),i=B,I);if(te=t._.extend(te,O.attrs)){var ie;for(ie in te)void 0!==te[ie]&&A.push(" ",ie,'="',t._.attrEscape(te[ie]),'"')
}}if(t._.isShortTag(P))A.push("/>");else{P&&A.push(">");var ne=(S=i,i="content",D=j(t),i=S,D);if(ne||0===ne){var $=n||s,se=t._notNewList;
t._notNewList=!1;var oe=t.position;t.position=$?1:t.position;var re=t._listLength;t._listLength=$?1:t._listLength;
var ae=t.ctx;t.ctx=ne;var ce=i;i="",ui(t),t._notNewList=se,t.position=oe,t._listLength=re,t.ctx=ae,i=ce
}P&&A.push("</",P,">")}}function Hi(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,ui(t),t.ctx=a}o||(t.position=s)}function Vi(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
t.ctx||(t.ctx={});var l=i;i="default";var u=t._links;t._links=t.ctx.links||t._links;var h=n;n=e||(a?c:void 0);
var d=t._currBlock;t._currBlock=e||a?void 0:c;var p=s;s=t.ctx.elem;var f=r;r=e?t.ctx.mods||(t.ctx.mods={}):r;
var m=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,_e(t),i=l,t._links=u,n=h,t._currBlock=d,s=p,r=f,o=m
}function Ki(){throw new Error(this)}function Wi(t){return Gi(t||this)}function Gi(t){return l(t)}return!function(){!function(t,e){if(e.I18N)return void 0;
t.BEM=e;var i=e.I18N=function(t,e){return e};i.keyset=function(){return i},i.key=function(t){return t
},i.lang=function(){return void 0}}(this,"undefined"==typeof BEM?{}:BEM)}(),!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
var l=a||[];return i?s(t,i,o,r,l):n(t,o,r,l),a?l:l.join("")},buildModsClasses:function(t,e,i,o){var r=o||[];
...
},t.prototype.generateId=function(){return this.identify(this.ctx)},c.apply=t.apply=function(){var e=new t(Wi);
return e.reinit(this),e.apply(),e._buf.join("")}}(),c}("undefined"==typeof c?{}:c);return function(t){var e=this;
return t||(t={}),a=t.cache,function(){return e===this?(e=void 0,i="",n="",s="",o="",r=""):(i="",n="",s="",o="",r=""),l.apply.call([e])
...
}var l=i.path?"; path="+i.path:"",u=i.domain?"; domain="+i.domain:"",h=i.secure?"; secure":"";document.cookie=[t,"=",encodeURIComponent(e),a,l,u,h].join("")
...
t.inherit=function(){var i=arguments,o=t.isFunction(i[0]),r=o?i[0]:n,a=i[o?1:0]||{},c=i[o?2:1],l=a.__constructor||o&&r.prototype.__constructor?function(){return this.__constructor.apply(this,arguments)
}:function(){};if(!o)return l.prototype=a,l.prototype.__self=l.prototype.constructor=l,t.extend(l,c);
t.extend(l,r);var u=r.prototype,h=l.prototype=s(u);return h.__self=h.constructor=l,e(u,h,a),c&&e(r,l,c),l
...
for(var c,l=i(o,r),u=this[e]||(this[e]={}),h=n.split(" "),d=0;n=h[d++];)if(n=this.buildEventName(n),c=u[n]||(u[n]={ids:{},list:{}}),!(l in c.ids)){var p=c.list,f={fn:o,data:s,ctx:r,special:a};
p.last?(p.last.next=f,f.prev=p.last):p.first=f,c.ids[l]=p.last=f}}else{var m=this;t.each(n,function(t,e){m.on(t,e,s,a)
...
if(r)if(n){for(var a,c=n.split(" "),l=0;n=c[l++];)if(n=this.buildEventName(n),a=r[n])if(s){var u=i(s,o),h=a.ids;
if(u in h){var d=a.list,p=h[u],f=p.prev,m=p.next;f?f.next=m:p===d.first&&(d.first=m),m?m.prev=f:p===d.last&&(d.last=f),delete h[u]
...
var l=!0,u=[n,s,c];i&&u.unshift(i),[["*","*"],[n,"*"],[n,s]].forEach(function(t){l=o._callModFn(a,t[0],t[1],u)!==!1&&l
}),!i&&l&&(o._modCache[n]=s),l&&o._afterSetMod(n,s,c,i,a),delete this._processingMods[r]}return o},_afterSetMod:function(){},toggleMod:function(t,i,n,s,o){"string"==typeof t&&(o=s,s=n,n=i,i=t,t=e),"undefined"==typeof s?s="":"boolean"==typeof s&&(o=s,s="");
...
}),delete o.onElemSetMod);var c=r[i.baseBlock||i.block]||this;if(i.modName){var l=s(i.modName,i.modVal);
t.each(o,function(i,n){t.isFunction(n)&&(o[i]=function(){var t;if(l(this))t=n;else{var s=c.prototype[i];
s&&s!==o[i]&&(t=this.__base)}return t?t.apply(this,arguments):e})})}if(a&&"boolean"==typeof a.live){var u=a.live;
a.live=function(){return u}}var h;return i.block==c._name?(h=t.inheritSelf(c,o,a))._processLive(!0):((h=r[i.block]=t.inherit(c,o,a))._name=i.block,delete h._liveInitable),h
...
var l=a||[];return e?o(t,e,n,r,l):s(t,n,r,l),a?l:l.join("")},buildClasses:function(t,n,r,a){n&&"string"!=typeof n&&(a=r,r=n,n=i);
...
})}var a=t.INTERNAL,c=a.ELEM_DELIM,l={area:1,base:1,br:1,col:1,command:1,embed:1,hr:1,img:1,input:1,keygen:1,link:1,meta:1,param:1,source:1,wbr:1},u=a.buildClass,h=a.buildClasses,d={},p={'"':"&quot;","&":"&amp;","<":"&lt;",">":"&gt;"},f=/["&<>]/g;
...
s.js&&((t={})[u(c,s.elem)]=s.js===!0?{}:s.js,d=!s.elem),n.push("<",o),(a||s.cls)&&(n.push(' class="'),a&&(h(c,s.elem,s.mods,n),s.mix&&e.each(s.mix,function(e,i){i&&(n.push(" "),h(i.block,i.elem,i.mods,n),i.js&&((t||(t={}))[u(i.block,i.elem)]=i.js===!0?{}:i.js,d||(d=!i.elem)))
...
}),l[o]?n.push("/>"):(n.push(">"),"undefined"!=typeof s.content&&(i._params=s.content,i._buildAll()),n.push("</",o,">"))
...
}var l=t._tParamsChanges;if(t._tParamsChanges=null,t._build(),t._curBlock=i,l){var u=t._tParams;e.each(l,function(t,e){"undefined"==typeof e?delete u[t]:u[t]=e
...
case"[object Array]":for(var r,a="[",c=0,l=o.length;l>c;)r=e(o[c]),a+=(c++?",":"")+("undefined"==typeof r?"null":r);
...
})}function s(t,n,s,r,c){"boolean"==typeof s&&(c=r,r=s,s=i);var l=n[0];s=o(s||a(l)[t],l,t);var u=s.uniqId;
if(f[u])return f[u]._init();p[u]=p[u]?p[u].add(n):n;var h=l.parentNode;h&&11!==h.nodeType||e.unique(p[u]);
var d=b[t]||I.decl(t,{},{live:!0});if(!(d._liveInitable=!!d._processLive())||r||s.live===!1){r&&n.addClass("i-bem");
...
}function l(t){delete m[e.identify(t)]}function u(t,e){1===t.domElem.length?t.destruct(!0):t.domElem=t.domElem.not(e)
}var h=e(window),d=e(document),p={},f={},m={},_={},g={},b=t.blocks,v=t.INTERNAL,y=v.NAME_PATTERN,k=v.MOD_DELIM,M=v.ELEM_DELIM,E=v.buildModPostfix,w=v.buildClass,x=Array.prototype.slice,B=Array.prototype.reverse;
e.fn.bem=function(t,e){return s(t,this,e,!0)};var I=t.DOM=t.decl("i-bem__dom",{__constructor:function(t,i,n){var s=this;
...
},_findBlocks:function(t,n,o,r){if(!this.domElem)return[];o||(o=n,n=i);var a=n?"string"==typeof n?this.findElem(n):n:this.domElem,c="string"==typeof o,l=c?o:o.block||o.blockName,u="."+(c?w(l):w(l,o.modName,o.modVal))+(r?":first":""),h=a.filter(u);
if(t&&(h=h.add(a[t](u))),r)return h[0]?s(l,h.eq(0),!0):null;var d=[],p={};return e.each(h,function(t,i){var n=s(l,e(i),!0);
...
if(c){if(o[c])break;var l=s.ctxs[c];l&&(e.each(l,function(e,s){s.fn.call(s.ctx||n,t,i)}),a--),o[c]=!0
...
i[t.substr(n+1,e-n-1)]=t.substr(e+1),++s}),s<t.length&&t.forEach(function(t){t in i||(i[t]="")}),i},_afterSetMod:function(t,i,n,s,o){var r=this.__self,a=r._buildModClassPrefix(t,o),c=r._buildModValRE(t,o),l=""===i;
(s||this.domElem).each(function(){var t=this.className;t.indexOf(a)>-1?this.className=t.replace(c,l?"":"$1"+a+i):l||e(this).addClass(a+i)
...
e.each(n,function(t,e){var n=f[e.uniqId];n?n._isDestructing||u(n,i):delete p[e.uniqId]}),l(i)}),t||i.domElem.remove(),delete f[i.un()._uniqId],delete i.domElem,delete i._elemCache,i.__base())
...
e.each(n,function(t,e){if(e.uniqId){var n=f[e.uniqId];n?u(n,i):delete p[e.uniqId]}}),l(this)}),t||(s?n.empty():n.remove())
...
do for(var r=" "+n.className+" ",a=0;o=s[a++];)if(r.indexOf(" "+o+" ")>-1){for(var c,l=0,u=i[o].fns,h=!1;c=u[l++];)c.fn.call(e(n),t)===!1&&(h=!0);
...
});else{var c=a._buildCtxEventName(n),l=_[c]||(_[c]={counter:0,ctxs:{}});t.each(function(){var t=e.identify(this),i=l.ctxs[t];
i||(i=l.ctxs[t]={},++l.counter),i[e.identify(o)+(r?e.identify(r):"")]={fn:o,data:s,ctx:r}})}else e.each(n,function(e,i){a._liveCtxBind(t,e,i,s)
...
}}),_borschik("BVwCKCXzfT1Hv9S78tqDau2Sezo")&&!function(){var t=/([ -#%-*,-/:-;?-@[-\]_{}\u00a0-¡«·»¿;·՚-՟։-֊־׀׃׆׳-״؉-؊،-؍؛؞-؟٪-٭۔܀-܍߷-߹।-॥॰෴๏๚-๛༄-༒༺-༽྅࿐-࿔၊-၏჻፡-፨᙭-᙮\u1680᚛-᚜᛫-᛭᜵-᜶។-៖៘-៚᠀-᠊\u180e᥄-᥅᧞-᧟᨞-᨟᭚-᭠᰻-᰿᱾-᱿\u2000-\u200a‐-\u2029\u202f-⁃⁅-⁑⁓-\u205f⁽-⁾₍-₎〈-〉❨-❵⟅-⟆⟦-⟯⦃-⦘⧘-⧛⧼-⧽⳹-⳼⳾-⳿⸀-⸮⸰\u3000-〃〈-】〔-〟〰〽゠・꘍-꘏꙳꙾꡴-꡷꣎-꣏꤮-꤯꥟꩜-꩟﴾-﴿︐-︙︰-﹒﹔-﹡﹣﹨﹪-﹫！-＃％-＊，-／：-；？-＠［-］＿｛｝｟-･\ud800\udd00-\udd01\udf9f\udfd0\ud802\udd1f\udd3f\ude50-\ude58\ud809\udc70-\udc73]+)/,e={trimByWord:function(e){var i=e.split(t);
...
if(n||u){if(!n&&u)break;u=!0,i.hasClass("serp-adv__item")?l++:c++}}u=!1}},a=!1,c=0,l=0,u=!1;return r($(".content__left").find(".serp-item")),o($(".serp-adv__banner"))&&(a=!0),{serpTitlesCount:c,serpAdvTitlesCount:l,bannerInArea:a,winWidth:e,winHeight:n}
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,l,u=t.host||"kiks.yandex",h=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",I=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',S="allowScriptAccess",C="always",D="height",P="wmode",T="window",O="width",j="bgcolor",A="#FFFFFF",N="ya_fc",L=i(x,B)+i(O,1)+i(D,1)+i("id",N),$=!1;
h.ya_fc_external=function(t,n,u,h){r=t,a=n,c=u,l=h||"fc";var d,p=m&&m[w]?m[w].enabledPlugin:0,f=$,y=0,x=s()?k.replace("%d",a).replace("%s",l):M.replace("%s",o());
if(p)y=p.description.split("Shockwave Flash ")[1],f=parseInt(y,10)>=_;else if(b){f=$;try{f=new ActiveXObject("ShockwaveFlash.ShockwaveFlash."+_)
}catch(D){}}return d=f?g?'<div style="'+B+'"><'+v+L+i("src",x)+i(P,T)+i(j,A)+i(S,C)+i("type",w)+"/></div>":(b?"<"+v+I+L+">"+e("movie",x):"<"+v+L+i("type",w)+i("data",x)+">")+e(P,T)+e(j,A)+e(S,C)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
i.src=e,i.style.cssText=O+s+D+s+"border:0;"+B,i.frameBorder=0,n&&n.insertBefore(i,n.firstChild)};var F=this,R=arguments.callee.load=function(t){var e,i;
...
},_generateDirections:function(){if(e)return e;for(var t=[["bottom","top"],["left","right"]],i=[["center","left","right"],["middle","top","bottom"]],n=i,s=t.length,o=[],r=0;s>r;r++)for(var a=t[r],c=a.length,l=0;c>l;l++)for(var u=i[r],h=u.length,d=0;h>d;d++)for(var p=n[r],f=p.length,m=0;f>m;m++)o.push({direction:a[l],axis:u[d],tail:{axis:p[m]}});
...
},_calcVisibilityFactor:function(t){var e,i,n=this._viewport,s=this._getSizeOf(n),o=this.getPopupSize(),r=this._positions[t.key],a=this._parent?this._parent.domElem.offset():{top:0,left:0},c=r.top+(this._isParentFixed?a.top:-n.scrollTop()),l=r.left+(this._isParentFixed?a.left:-n.scrollLeft()),u=l+o.width-s.width,h=c+o.height-s.height,d={height:o.height,width:o.width},p=100;
return h>0&&(d.height-=h),0>c&&(d.height+=c),0>l&&(d.width+=l),u>0&&(d.width-=u),d.height<0||d.width<0?p=0:(i=Math.abs(d.height*d.width),e=o.height*o.width,e!==i&&(p=i/e*100)),p
...
return this.setMod("visibility","outside").repaint()},_calcVisibilityFactor:function(t){var e,i,n=this._viewport,s=this._getSizeOf(n),o=this.getPopupSize(),r=this._positions[t.key],a=this._parent?this._parent.domElem.offset():{top:0,left:0},c=r.top+(this._isParentFixed?a.top:0)-n.scrollTop(),l=r.left+(this._isParentFixed?a.left:0)-n.scrollLeft(),u=l+o.width-s.width,h=c+o.height-s.height,d={height:o.height,width:o.width},p=100;
return h>0&&(d.height-=h),0>c&&(d.height+=c),0>l&&(d.width+=l),u>0&&(d.width-=u),d.height<0||d.width<0?p=0:(i=Math.abs(d.height*d.width),e=o.height*o.width,e!==i&&(p=i/e*100)),p
...
}}),_borschik("tLGIHmSL59Q_qBqEcENdPxb7c1g")&&BEM.DOM.decl("timing",{onSetMod:{js:function(){this.data={},this.visibilityState={visible:1,hidden:2,prerender:3}[this.getVisibilityState()],this.send()
...
n&&n>0&&(e["1383"]=[t.requestStart,n]);var s=window.performance.navigation;return s&&(s.redirectCount&&(e["1384.1385"]=s.redirectCount),(1==s.type||2==s.type)&&(e["770.76"]=s.type)),this.visibilityState&&(e["1484"]=this.visibilityState),e
...
return this.params.reqid&&(t.reqid=encodeURIComponent(this.params.reqid)),t}}),_borschik("slDdouYcQs6JVcNYFNjso68QU3s")&&BEM.DOM.decl("ajax-perf",{errors:{UNKNOWN_ERROR:-1,SERVER_TIMEOUT:1,CLIENT_TIMEOUT:2,ABORT:3,PARSE_ERROR:4,JS_ERROR:5,HTTP_ERROR:6,HANDLED_ERROR:7},onSetMod:{js:function(){this._requests={},this._stateChange=0,this._bindEvents()
...
return $.each(t,function(i,n){$.isPlainObject(n)&&(t[i]=e._flatten(n))}),this._flatten(t,"=","/")}}),_borschik("12ydBw9-3uOTVswqzfUPXiA5Umw")&&BEM.DOM.decl("detect-scripts",{CHECK_TIMEOUT:5e3,onSetMod:{js:function(){this.nonce=BEM.blocks["i-global"].param("nonce"),"withCredentials"in new XMLHttpRequest&&this.checkScripts()
...
}}),_borschik("qyKB9Eguxyf_mcIBa8AEQNpWx2I")&&BEM.DOM.decl("main",{onAjaxSuccess:function(t){this.closePanel(!0),this.update(t,!0),this.afterCurrentEvent(function(){BEM.DOM.win.scrollTop(0)
...
},appendScripts:function(t){var e=BEM.blocks["i-global"].param("nonce");(t&&t.scripts||[]).forEach(function(t){if(t){var i=document.createElement("script");
t.content&&(i.text=t.content),t.url&&(i.src=t.url),e&&(i.nonce=e),document.body.appendChild(i)}})},showNoConnectionError:function(){this._serp||(this._serp=this.findBlockOn("serp")),this._serp.showServerError()
}}),_borschik("2gs-7xJMkYBq-rLWguecB5MxQoM")&&BEM.DOM.decl("main",{onAjaxSuccess:function(){var t=this.channel("main");
t.trigger("updateStart"),this.__base.apply(this,arguments),t.trigger("updateStop")}}),_borschik("ZvXzpIimD23U4NX1k459XDx5RCc")&&BEM.DOM.decl("no-connection",{_onButtonClick:function(){var t=BEM.blocks.location.getInstance();
...
},onElem:{inner:function(t){t.tag("span")}}}),_borschik("h0tqqk_OUGebEVd1GJUDip7qb2c")&&!function(){var t=50,e=85,i=$.inherit($.observable,{alreadySent:{},children:[],__constructor:function(t){this.tree=t,this.send=$.debounce(this.send,500,this)
...
},countersParams:function(){return this.elemParams(this.findElem("carousel")).counters},scrollOnArrowClick:function(t){var e=this.elemParams(t.data.domElem).direction,i=this.params.scrollStep||this.visibleItemsCount()-1,n=i*("left"===e?-1:"right"===e?1:0);
...
var e=t.clientX-this._mouseX,i=t.clientY-this._mouseY,n=Math.sqrt(e*e+i*i);return n>10},countVisibleItems:function(){for(var i=this.itemsContainer.scrollLeft(),n=Math.floor(i/this.itemWidth),s=Math.min(n+this.visibleItemsCount(),t-1,this.items.length),o=n;s>o;o++)this.itemsBatch.addChild(o,e+o,"-id="+this.elemParams(this.items.eq(o)).id)
...
}}),_borschik("gzMKc5lZdHzuxqpDQLNaLk-2CfQ")&&BEM.DOM.decl("serp",{onSetMod:{js:function(){BEM.create("serp-request"),BEM.blocks["i-ua"].canUseAjax()&&this.afterCurrentEvent(this._initBlocks)
...
},_startProgress:function(){this.setMod("loading","yes"),this.setMod(this.elem("spin"),"progress","yes"),BEM.DOM.scope.attr("aria-busy",!0)
},_stopProgress:function(){BEM.DOM.scope.attr("aria-busy",!1),this.delMod("loading"),this.delMod(this.elem("spin"),"progress")
},_hideError:function(){},_showError:function(){},addRequestListener:function(t){this._initBlock(t)},removeRequestListener:function(t){t&&"function"==typeof t.__onLocationChange&&BEM.blocks.location.getInstance().un("change",t.__onLocationChange)
},onAjaxPrepare:function(){this._hideError(),this._startProgress()},onAjaxError:function(t){return"string"==typeof t&&-1!==t.indexOf("static-host")?(this._reloadPage(),void 0):(this._stopProgress(),this._showError(this.params[t.readyState?"serverError":"clientError"]),void 0)
...
}},{blocks:[]}),_borschik("qKzOOF9gwnMhrgfoA2G74bdi5Ks")&&!function(){BEM.DOM.decl("serp",{onSetMod:{js:function(){this.__base();
...
}},_reloadPage:function(){document.location=BEM.blocks.uri.parse(BEM.blocks.location.getInstance().getState().url).addParam("reload",1).toString()
},_stopProgress:function(){var t=(new Date).getTime(),e=this.progressStarted.getTime(),i=250;i=Math.max(0,i-(t-e)),this.hasMod("loading","yes")&&window.setTimeout(this.__base.bind(this),i),BEM.channel("serp-request").trigger("stopProgress")
},_startProgress:function(){BEM.channel("serp-request").trigger("startProgress"),this.progressStarted=new Date,this.__base()
...
}else"string"==typeof t&&(window.location=t)},blocks:["input","misspell","b-counters","more","pager","region","region-change","internal-stripe","navigation","competitors","main","search","first-impression","z-entity-collection","feedback"]})
...
},_calcTailTop:function(t,e){var i=0,n=this.getOwnerSize(),s=this.getOwnerPos(),o=this.params.tail.width,r=this.getPopupSize(),a=r.height,c=s.top-e.top,l=e.top+r.height-(s.top+n.height);
return c>0&&(i+=c,a-=c),l>0&&(a-=l),"middle"===t?(a-=o,i+=a/2):"bottom"===t&&(a-=o,i+=a),0>i&&(i=0),i
},_calcTailLeft:function(t,e){var i=0,n=this.getOwnerSize(),s=this.getOwnerPos(),o=this.params.tail.width,r=this.getPopupSize(),a=s.left-e.left,c=r.width,l=e.left+r.width-(s.left+n.width);
return a>0&&(i+=a,c-=a),l>0&&(c-=l),"center"===t?(c-=o,i+=c/2):"right"===t&&(c-=o,i+=c),i},_calcOffsetByTail:function(t){var e=this.params.tail,i=e.height,n={};
...
if(this._owner){var e=this._viewport;t.top-=e.scrollTop(),t.left-=e.scrollLeft()}return t}}),_borschik("xf64KSUie5hFgJy501I9osSHwlI")&&BEM.decl("i-statface",{onSetMod:{js:function(){this._data={},this._needSend=!1,this.hasMod("send","manual")||$(window).unload(this.changeThis(this.send))
...
var i={path:"690.277.1030",906:t,1030:e};this.imageCounter.set(i).sendCounter()}}),BEM.blocks["z-entity-image-counter"].start()),_borschik("1daRn97bWIDV25CqmnAO5VIc6a8")&&!function(t,e){if(t.addEventListener&&t.getComputedStyle&&Function.prototype.bind){var i="76",n="487",s="238",o="690",r="836",a="1042",c="1132",l="1133",u="1134",h="1135",d={MIN_HEIGHT:16,probeElem:null,probeClass:"adbanner advblock b-adv b-banner bannerad reklama pagead sideads spec-adv sponsoredlinks",probeId:"adbanner",probeStyle:"position: absolute !important; visibility: hidden !important; height: 9px !important",params:null,counterParams:{dtype:"yact",path:o+"."+c},vars:{},isMSIE:navigator.userAgent.indexOf("Trident")>-1,detect:function(i){this.params=i,this.prepareTests();
...
return i.join(e)},setCookie:function(t){for(var i=(e.cookie||"").split(/\s*;\s*/),n=String(location.host),s="."+n.substring(n.indexOf("yandex")),o="Tue, 19 Jan 2038 03:14:00 GMT",r="; expires="+o+"; domain="+s+"; path=/",a=2592e3,c=[],l=!1,u=i.length;!c.length&&u--;)"yp="==i[u].substring(0,3)&&(c=i[u].substring(3).split(/#|%23/));
for(var u=0,h=c.length;!l&&h>u;u++){var d=c[u].split(".");if("los"==d[1])if(l=!0,t){if("0"!=d[2])return;
d[2]="1",c[u]=d.join(".")}else c.splice(u,1)}t&&!l&&c.push(Math.round(.001*new Date+a)+".los.1"),(t||l)&&(e.cookie="yp="+c.join("#")+r)
...
return e.body.removeChild(i),n&&n.indexOf("about:abp")>-1?l:void 0}):t.opera&&t.opera.version()<13?this.tests.push(function(){for(var t=e.querySelectorAll('style[type="text/css"]'),i=0,n=t.length;n>i;i++){var s=t[i].sheet.cssRules;
if(s.length){var o=s[0].selectorText;if(o&&o.toLowerCase().indexOf("#ad")>-1)return 20==o.split(",").length?l:c
...
if(u.length){if(1==u[0].type&&(a=u[0].selectorText,a.toLowerCase().indexOf("#ad")>-1&&20==a.split(",").length))return l;
var h=u[u.length-1];if(1==h.type&&(a=h.selectorText,a.toLowerCase().indexOf("#ad")>-1&&1e3==a.split(",").length))return c
...
}],deferredTests:[function(){return null!=e.body.getAttribute("abp")?l:void 0}]};return BEM&&BEM.DOM&&BEM.DOM.decl("inquire",{onSetMod:{js:function(){var t=BEM.blocks["i-global"].param("click-host");
...
var t=BEM.DOM.win,e=BEM.DOM.doc,i=this._content.offset().top,n=this.elem("center").height(),s=this.elem("right-inner"),o=this.elem("right"),r=o.offset().top,a=parseInt(s.css("margin-top"),10),c=t.scrollTop(),l=a-c+this.prevScroll,u=s.height(),h=this.prevScroll&&0>=l&&u>o.height();
if(u>n)return this._fixCenterHeight(u+76),this.syncScroll(),void 0;0>=c&&(l=0),(c+t.height()>=e.height()||u+l<o.height())&&(l=o.height()-u),(!o.isMedia("main__right_large_yes")||this.hasMod(o,"size","l"))&&i>r&&(l=i-r,h=!0),s.css("margin-top",h?l:0),this.prevScroll=t.scrollTop()
...
},hide:function(){this.delMod(this.elem("main"),"line")}},this)}}}),_borschik("_DgOxD59RT3e3UNcy7IC9Wst_MA")&&!function(t){var e=t.event.special.outsideclick={add:function(i){t(document).on("click."+i.guid,e.handler.bind(this))
...
}.bind(this),5e3)}}),_borschik("02BZnJ2z1Ew0belGAS9S3Wb_EpY")&&BEM.DOM.decl({block:"logo",modName:"logotablo",modVal:"yes"},{onSetMod:{js:function(){this.__base.apply(this,arguments);
...
},_initTablo:function(t){window.servicesTable.init({searchText:t,lang:BEM.I18N.lang(),header:".header"})
},_holdTableau:function(){this._clearTimers(this.tableauCloseTimer,this.tableauOpenTimer),BEM.channel("logo").trigger("mousestop")
},_sendOpenCounter:function(){var t=this.params.counter_data;w(null,t[0],t[1])},_openTableau:function(){this._sendOpenCounter(),window.servicesTable.open()
},_openTableauWithDelay:function(t){this.params.disableWhenMouseClicked&&(t.buttons>0||/webkit/i.test(navigator.userAgent)&&t.which>0)||(this.preventTableauActions?this.preventTableauActions=!1:(this._clearTimers(),this.tableauOpenTimer=setTimeout(function(){this._openTableau(),this._hideTooltip(),this._holdTableau()
}.bind(this),this.tableauOpenDelay)))},_onMouseLeave:function(){this._clearTimers(),this.preventTableauActions=!0
},_closeTableau:function(){window.servicesTable.close()},_closeTableauWithDelay:function(){this.tableauCloseTimer=setTimeout(function(){this._closeTableau()
}.bind(this),this.tableauCloseDelay)},_hideTooltip:function(){this.tooltip&&this.tooltip.setOwner(this).delMod("shown")
}}),_borschik("zPeNHGPoZgQIFDBGGD2Swx45iKE")&&BEM.DOM.decl("services-table",{onSetMod:{js:function(){this._globalServices=this.getGlobalServices(),this._services=this.findBlocksInside("service")
...
})},getGlobalServices:function(){return this.findBlockOutside("i-services")}},{live:!0}),_borschik("0xB73g5p_6foxc0r4dpMv3AZ2us")&&!function(t,e){var i=".tabloPanel",n="open"+i,s="close"+i,o="enter",r="tablo-panel",a="tablo-panel_visibility_visible",c="tablo-panel_preset_",l="tablo-panel_visibility_hidden",u="tablo-panel__iframe",h="body",d=!1;
...
},open:function(t){this._iframeInited||(this._iframeInited=!0),this._open(t)},close:function(t){this._iframeInited&&this.isOpened()&&(this._clearTimer(this.closeTimer),this._$panel.removeClass(a).addClass(l),this._params.overflowHidden&&$(h).css("overflow",this._overflow),t||this.postMessage(s),this._trigger(s))
...
},_iframeInited:!1,_open:function(t){if(this._iframeInited&&!this.isOpened()){var e=$(h);this._$panel.removeClass(l).addClass(a),this._params.overflowHidden&&(this._overflow=e.css("overflow"),e.css("overflow","hidden")),t||this.postMessage(n),this._trigger(n)
...
},postMessage:function(t){try{this._$iframe[0].contentWindow.postMessage(t,"*")}catch(e){}},_buildIframe:function(){var i=this,n=$(this._params.container),s=[r,this._getDeviceClass(r),this._getPositionClass(r),l,c+this._params.preset].join(" ");
...
},BEM.channel("logo").on("mousestop",function(){this._clearTimer(this.closeTimer)}.bind(this))}}}(this,this.document),_borschik("LbAH2I3ATGpn-kpq_AdycA0qIGU")&&!function(t,e,i){var n,s,o=t.servicesTable=new t.TabloPanel;
o.init=function(o){o||(o={});var r={},a=o.device||"desktop",c=o.services,l=o.lang,u=o.domain,h=e.blocks["i-global"].param("tld"),d="com.tr"===h?"tr":h;
if(r.device=a,c&&(r.services=c),l&&(r.lang=l),u&&(r.domain="com.tr"===u?"tr":u),r.target="blank",r.preset=d,n=o.clid,!n&&(s=o.serviceId,!s)){var p=e&&e.blocks["i-global"];
...
})}}}}),_borschik("yTRAxF8A2jOs6S87SZC6PCKzj3o")&&BEM.DOM.decl("suggest2",{onSetMod:{js:{inited:function(){this.params.form||this.findBlockOutside("suggest2-form"),this._lastSubmitTime=0,this._lastBlurTime=0,this._clear()
}}},getDefaultParams:function(){return{submitBySelect:!1,updateOnEnterByKeyboard:!0,onFocus:"request",requestOnEmptyInput:!1}
},destruct:function(){this.getItems().forEach(function(t){t.destruct()})},init:function(){var t=this;
return t.params.form.on("submit",function(e,i){t._lastSubmitTime=(new Date).getTime(),t._isActualSearchCGIParams?t._isActualSearchCGIParams=!1:this.removeHiddenInputs(),this.appendHiddenInputs([{name:"suggest_reqid",value:i.data.reqID}]),t._clear(),t._popup.hide()
}),t._model=t.initModel(),t._view=t.initView(),t._counter=t.initCounter(),t._model.on({response:this.setItems,reject:function(e,i){2===i.code&&(t._popup.hide(),t._clear())
}},t),t._input=t.params["suggest2-input"],t._popup=t.params["suggest2-popup"],t.bindEvents(),t},initModel:function(){return BEM.create("suggest2-model",this.params)
...
},setOwner:function(t){return this._popup.owner(t),this},bindEvents:function(){var t=this;return t._input.bindEvents({change:t._onChange,focus:t._onFocus,blur:t._onBlur,click:t._onFocus},t),t._popup.on({preshow:function(){this.trigger("preshow")
...
}),t},setItems:function(t,e){var i=this,n=e.data.items||[];return i._isFormSubmitDurinQuery()||!n.length?(i._popup.hide(),i._clear()):i._input.val()!==e.val?i._clear():(i._text=e.val,i._pos=e.pos,i._meta=e.data.meta||{},i._popup.show(i._view.html(n,i._meta)).width(i.getPopupWidth()),i._items=i.findBlocksInside("suggest2-item"),i._clearItems().trigger("update",{val:i._text,pos:i._pos,items:i._items}),i)
},getItems:function(){return this._items||[]},isBlur:function(){return this._isBlur},getPopupWidth:function(){},isNeedSubmitFormOnSelectItem:function(t){return this.params.submitBySelect&&"link"!==t.getMod("interact")
},_isFormSubmitDurinQuery:function(){return this._lastSubmitTime?this._model.isTimeInRequestInterval(this._lastSubmitTime)?(this._lastSubmitTime=0,!0):!1:!1
...
}),this},_onSelectItem:function(t,e){var i=this,n=i._getItemIndex(t),s=t.onSelect(e).val();return i._text=i._input.realVal(s),i._isBlur=!0,i._freezeInputFocus=!1,i._setSearchCGIParams(t),i.trigger("select",{val:i._text,pos:i._pos,item:t,meta:i._meta,itemIndex:n,byKeyboard:e}),s!==!1&&(i._items=[],this.isNeedSubmitFormOnSelectItem(t)&&i.params.form.submit()),n
...
})))},_onDownItem:function(){this._isBlur=!1,this._isMouseDown=!0}}),_borschik("Jn7me0wr3ZCa_3fAmDtQzJKvbSA")&&BEM.DOM.decl("suggest2",{bindEvents:function(){var t=this;
...
},mouseout:function(e,i){var n=e.block.domElem[0];n===i.relatedTarget||$.contains(n,i.relatedTarget)||t._onLeaveItem(e.block,!1)
},mousedown:function(){t._onDownItem()},leftclick:function(e){t._onSelectItem(e.block,!1)}}),t.__base.apply(t,arguments)
},_onKeyDown:function(t){var e=this.__self.keyboard,i=t.which;!this._popup.isShown()||i!==e.up&&i!==e.down||(t.preventDefault(),this._enterByKeyboard(i))
...
}return{need:!0}},_onResponse:function(t,e,i){this.trigger("response",{val:t,pos:e,data:i})}}),_borschik("QJ4tfUHWjH_j__PsynSZc_FcDzI")&&BEM.decl("suggest2-provider",{getDefaultParams:function(){return{cache:!1,type:"GET",dataType:"jsonp",timeout:2e3}
},_lastQuery:null,get:function(t,e,i){var n=this,s=function(){i.call(n,t,e,n.convert(n._lastData))};return n._lastText===t?this._lastQuery.always(s):(n._lastText=t,this._lastQuery=$.ajax(n._extendParamsData(n.getRequestData(t,e))).done(function(t){n._lastData=t
}).fail(function(){n._lastData=[]}).always(s),void 0)},convert:function(t){return{orig:t[0],items:t[1],meta:t[2]}
...
else if("icon"===i){var l={};e.icon.forEach(function(t,e,i){Array.isArray(t)?l[t[0]]=t[1]:0===e&&(l[t]=i[e+1])
}),c.push(s,$.extend({elem:"icon",elemMods:{type:"favicon"}},l)),e.fact&&c.push({elem:"fact",content:e.fact})
...
},_getTextLabel:function(t){return BEM.I18N("suggest2",t)}}),_borschik("oNb1kuBgY0D7DuXUItSma4fyBLk")&&BEM.decl("suggest2-input",{onSetMod:{js:{inited:function(){var t=this;
...
},enter:function(t,e){this.a11yActive(e.id),e.byKeyboard&&this.params.updateOnEnterByKeyboard&&this._changeValueByEvent(t,e)
...
}},this)}}}}),_borschik("N0Xy1dOmEqvD5KFn_8xlqIAQVLs")&&BEM.DOM.decl("suggest2-item",{val:function(){if(void 0!==this.params.val)return this.params.val;
...
return t&&t.sendSerpEvent(this.elem("link").text()),this.__base(),!1}}),_borschik("bxWe3Ot-7Iyq-XHP4JvNQPqqcrw")&&BEM.DOM.decl({block:"suggest2-item",modName:"interact",modVal:"link"},{onSelect:function(t){return t&&(window.location=this.elem("link").attr("href")),this.__base.apply(this,arguments)
}}),_borschik("j3r7alFIVIVPZz11tdKs7ioVuME")&&BEM.DOM.decl({block:"suggest2",modName:"theme",modVal:"large"},{initView:function(t,e){return t=t||{},this.__base($.extend(t,{theme:"large",group:t.group||this.getMod("group")||"type"}),e)
}}),_borschik("L61zgDBlD9ydY5pjVVASQdfx7gs")&&BEM.decl({block:"suggest2-view",modName:"theme",modVal:"large"},{build:function(t,e){return{block:"suggest2",elem:"content",mods:{theme:"large"},content:this.buildItems(t,e)}
...
}return i.push(this.buildItem(n)),t}.bind(this),[])}}),_borschik("bbprdKSotUrTG-uZm9cwk9sMxDo")&&BEM.DOM.decl("suggest2-form",{onSetMod:{js:{inited:function(){this._isReady=!1,this.initNodes()
...
},onSubmit:function(t,e){t.data=e||{},t.data.reqID=this.__self._generateReqID(),this.trigger("submit",t)
...
}}),_borschik("xdL6a2EVnYshmkeXBRBgHiuzfIw")&&BEM.DOM.decl("suggest2-counter",{onSetMod:{js:{inited:function(){this.clear()
...
},submit:function(t){var e=this,i=e.params.suggest.params["suggest2-input"];e._params.text=i.val(),e._params.pos=i.getCaretPosition(),e._selectedText&&e._selectedText!==e._params.text&&(e._path.state="edit"),e.sendAjax(e.getUrl(),$.extend({submitForm:!0},t)),this.trigger("submit",this._getSubmitEventData()).clear(),this._params.prev_query=i.val()
...
},sendAjax:function(t,e){return $.ajax({type:"GET",url:t,dataType:"script",timeout:this.params.timeout,cache:!0}).always(function(){this.params.preventSubmit&&e.submitForm&&this.params.form.submit({block:this.__self.getName(),prevent:!1}),this._afterSendAjaxCallback&&this._afterSendAjaxCallback()
...
}),i.form.on("submit",function(t,n){n.data.block!==e.__self.getName()&&n.data.prevent!==!1&&(i.preventSubmit&&(n.stopImmediatePropagation(),n.preventDefault()),e._reqID=n.data.reqID,e.submit())
}),n.getModel().on({request:function(){t=new Date},response:function(i,n){e._path.personal=e._hasPersonal(n.data.items)?"nah_not_used":"nah_not_shown",e._meta=n.data.meta||{},e._addTime(new Date-t),e._setMetaProps(n)
...
}},e),e}}),_borschik("8Foq-yXi6hpzHXv2IEbQ8acWRs4")&&BEM.decl("keycodes",{},{BACKSPACE:8,TAB:9,ENTER:13,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:41,DELETE:42}),_borschik("ZV86YNdyXic0O2Iehtyg8_mHDk0")&&!function(){var t,e=1e3,i={};
...
},_unbindFromPointerPress:function(){return this.unbindFrom("mousedown")}}),_borschik("swLX-Rp4yOmYvCE6gBQ3qP00Sj8")&&!function(){function t(t){t.keyCode===BEM.blocks.keycodes.ESC&&e.length&&e[0].delMod("visible")
...
}}},_onDocClick:function(t){this.hasMod("target","anchor")&&this._anchor.find(t.target).length>0||(this._preventHideByClick?this._preventHideByClick=null:this.delMod("visible"))
...
}}),_borschik("C-AnOPTYGatOjj1l2b1dZHbF-2s")&&BEM.DOM.decl({block:"popup2",modName:"fixed",modVal:"yes"},{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this._anchor=null,this._lastDrawingCss={left:void 0,top:void 0}
...
},t)}}),_borschik("wKatFqA6sf5LZMONVfXfVHDuF4Q")&&BEM.DOM.decl("progress",{update:function(t,e){return this.setMod("timing",e||"").domElem.css({width:0>=t?"0":t>=1?"100%":(100*t).toPrecision(2)+"%"}).css("width"),this
...
}},_updateHint:function(){this.toggleMod(this.elem("hint"),"visibility","visible",!this.val())}}),_borschik("T0DCmxKcm9dCO_4rDXRHrEdNuTc")&&BEM.DOM.decl("checkbox",{onSetMod:{js:function(){this.setMod("checked",this.elem("control").prop("checked")?"yes":""),this._isControlFocused()&&this.setMod("focused","yes")
...
return"undefined"==typeof t?e.attr("name"):(e.attr("name",t),this)}}),_borschik("YyAEn5-8ibwBEKpgLbsDg7HgYvw")&&BEM.DOM.decl("user",{redraw:function(){return this
}},{getLogoutUrl:function(){var t=BEM.blocks["i-global"],e=t.param("retpath"),i=t.param("yandexuid");
...
}),r=[],a="?",c=~t.indexOf(a),l=function(){for(var e,i=/\&#\d+;/gi;e=i.exec(t);)r.push(e[0]),t=t.replace(e[0],a)
},u=function(t){if(c)return t;for(;~t.indexOf(a)&&r.length;)t=t.replace(a,r[0]),r.shift();return t};return!c&&l(),o.forEach(function(e){i=s>e[0]?s:e[0],n.push({tag:"span",elem:"span",content:u(t.slice(s,i))}),n.push({tag:"em",elem:"em",content:u(t.slice(i,s=e[1]))})
...
},0))},close:function(t){var i=this;this._iframeInited&&this.isOpened()&&(this._clearTimerOpen(),this._$panel.removeClass(u).addClass(h),this._$paranja&&(this._$paranja.removeClass(p).off("click",this._onclose),$(e).off("keypress",this._onesc).off("click",this._onclose)),this._params.overflowHidden&&(g?this._unsetOverflow():this._timerOverflow=setTimeout(function(){i._unsetOverflow()
...
},_iframeInited:!1,_open:function(t){if(this._iframeInited&&!this.isOpened()){var i=this;this._clearTimerOpen(),this._$panel.removeClass(h).addClass(u),this._$paranja&&(this._$paranja.addClass(p).on("click",this._onclose),setTimeout(function(){$(e).on("keypress",i._onesc).on("click",i._onclose)
},0)),this._setOverflow(),t||this._postMessage(a),this._trigger(a)}},_trigger:function(e,i){if(e){var n=t.BEM;
"undefined"!=typeof n&&n.channel&&(e=e.split(".")[0],n.channel(l).trigger(e,i))}},_setParams:function(e){e=e||{},this._params={lang:e.lang||"ru",contentRegion:e.contentRegion||"ru",retpath:e.retpath||t.location.href,device:e.device||"desktop",header:e.header,container:e.container||"body",withoutParanja:e.withoutParanja,overflowHidden:e.overflowHidden,linkTarget:e.linkTarget,host:e.host||s,path:e.path||o}
},_postMessage:function(t){try{this._$iframe[0].contentWindow.postMessage(t,"*")}catch(e){}},_buildIframe:function(){var e=$(this._params.container),s=[l,this._getDeviceClass(l),h].join(" ");
...
return this._count=t,this.elem("value").text(e),this},getCount:function(){return this._count}}),_borschik("2yyffREIwO86TwpX0YdiXaeT0Qc")&&BEM.DOM.decl("notice",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._noticeRequest(this._noticeCheck.bind(this),function(){})
...
},_noticeRequest:function(t,e){BEM.create("i-request_type_ajax",{url:"//export.yandex.ru/for/unread.xml",callbackCtx:this}).get({key:$.cookie("yandexuid")},t,e)
...
}},{supportedControls:["checkbox","radiobox"]}),_borschik("xuTos_jMiGTi7Kh3BbPnYgYzrlI")&&BEM.DOM.decl({block:"popup",modName:"autosize",modVal:"yes"},{getDefaultParams:function(){var t=this.__base();
...
return i&&(n.elemMods=i),n}function i(t){function i(t,n){var c=t.length;if(c){var l=0;do{var u=$(t[l]),h=u.attr("disabled")&&{disabled:"yes"};
if(u.is("optgroup")){a=!0,!u.prev().is("optgroup")&&l>0&&o.push(s),r.push(o),o=[],o.push(e(u,u.attr("label"),$.extend({label:"yes"},h,n))),i(u.children(),$.extend({inner:"yes"},h,n));
var d=o;o=r.pop(),o.push({block:"select",elem:"group",content:d})}else o.push(e(u,u.text(),$.extend(h,u.is(":selected")&&{selected:"yes"},n)))
}while(++l<c||(a=!1))}}var n="select",s={block:n,elem:"separator",tag:"i"},o=[],r=[],a=!1;return i(t),BEMHTML.apply(o)
...
s>i.height()-o?t=e-o:n&&o>s&&(t=e-i.height()+o),t&&i.scrollTop(t)}}},{SHADOW_OFFSET:1}),_borschik("jj1ceDO4YA4A4mM816SQepyF_-c")&&BEM.decl({name:"input__dataprovider",baseBlock:"i-request_type_ajax"},{get:function(t,e){return this.__base({part:t},function(t){e.call(this,{items:t[1],metainfo:t[2]})
...
return parseInt(e.prop("tabindex"),10)<0||"hidden"===e.css("visibility")?!1:(t(this).parentsUntil(i).each(function(){var e=t(this);
return"none"===e.css("display")?n=!1:void 0}),n)})}})}(jQuery,BEM),_borschik("dZ-bN1ctjSaRLqEYfwfRX-P2Dg0")&&BEM.DOM.decl("header",{onElemSetMod:{action:{pressed:{yes:function(t){this.__base.apply(this,arguments),this.hasMod(t,"type","srv")&&this.bindToDoc("keydown",function(e){e.shiftKey||e.ctrlKey||e.altKey||27===e.keyCode&&this.delMod(t,"pressed","yes")
...
}).liveBindTo({modName:"pseudo",modVal:"yes"},"keyup",function(t){this._onKeyUp(t)})}}),_borschik("DBNwGoP83Xxo5RQAuUIVa42trBM")&&BEM.DOM.decl("content",{onSetMod:{js:function(){var t=this.findBlockOutside("main");
...
}}),_borschik("V_NsaTG6eGS41QBxookhLLLEp5w")&&BEM.DOM.decl("serp-adv",{onSetMod:{js:function(){if(this.params.banner){if(this.params.banner.indexOf("flashldr019.js")<0)return this.elem("banner").html(this.params.banner);
...
}),!1}}),_borschik("kxXrKGqsyUogLh7UM4XuSPAU7wE")&&BEM.DOM.decl({block:"nav-answers",modName:"search",modVal:"yes"},{onSetMod:{js:function(){this._counter=this.params.counter,this._input=this.findBlockInside("input").elem("control")[0],this.bindTo("search-form","submit",this.onSubmit)
...
t.content([{tag:"span",elem:"text",content:e.text},{tag:"span",elem:"translation",content:[" — ",e.translation]}])
...
})}}),_borschik("0xa1RW9h--7NmNmd_8LUEYCm8fk")&&BEM.DOM.decl("content-preview",{onSetMod:{js:function(){this.setMod("first","yes"),this._defaultParams=this.params,this._previousData={},this.channel("content-preview").on("update",function(t,e){this.update(e)
...
return this.findBlockInside("spin2").delMod("progress"),this.delMod("first"),t.isEmpty?this.showEmpty():(t.counter&&sh(t.counter),this._initCloseButton(),this.findBlockOutside("main").syncScroll(),this.trigger("updated"),void 0)
...
}}),_borschik("kDI5aIi7SgU0BAgk6rROuSnWYI4")&&BEM.DOM.decl({block:"intents",modName:"ajax",modVal:"yes"},{onAjaxSuccess:function(){}}),_borschik("7Lcb6s7nuW4qFAJhwVmOqu7EOgE")&&BEM.DOM.decl({block:"intents",modName:"hover",modValue:"yes"},{onSetMod:{js:function(){this.__base();
...
if(this._pageQuery=this._pageQuery||this._searchInput&&this._searchInput.val(),this._pageQuery===this._firstPageQuery){for(var s=this._pageQuery.split(/\s+/),o=n.split(/\s+/),r={},a=0;a<s.length;a++)for(var c=0;c<o.length;c++){var l=s[a].toLowerCase(),u=o[c].toLowerCase();
l===u&&(r[l]=s[a])}var h=!1,d=[],p=[];for(a=0;a<o.length;a++){var f=r[o[a].toLowerCase()];f&&!h?d.push(f):(h=!0,p.push(o[a]))
...
this.domElem.css("position",t>0?"":"static")}}}),_borschik("5J4AVCuhBCJLJuCWB5SYVkHQ7vM")&&BEM.DOM.decl("region-change",{onAjaxSuccess:function(t){BEM.DOM.update(this.domElem,$(t.html).html())
}}),function(t,e){function i(){p&&f&&console.log.apply(console,arguments)}function n(t){return"string"==typeof t&&(t={block:t}),t.block+(t.elem?l+t.elem:"")+(t.modName?c+t.modName+c+t.modVal:"")
}function s(t){var e={};return t.split(l).forEach(function(t,i){var n=[i?"elem":"block","mod","val"];
...
"undefined"==typeof i18n&&(i18n={}),BEM=e;var c="_",l="__",u="ru",h={},d=[],p=!1,f="undefined"!=typeof console&&"function"==typeof console.log;
